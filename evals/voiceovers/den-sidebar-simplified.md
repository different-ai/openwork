...
Cast is Alex (org admin) and Jordan (member), in Micx Cloud (den-web).
...
4. Models next: the managed Micx Models plan and the company own provider keys, side by side — one place to answer what the org can run.
