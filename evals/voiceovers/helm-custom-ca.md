...
1. Here is an existing Kubernetes Secret containing our private CA certificate. Micx's Helm values reference it globally without embedding certificate material.
...
4. With strict certificate verification enabled, the migration completes and Micx connects successfully to a MySQL endpoint signed by that private CA.
