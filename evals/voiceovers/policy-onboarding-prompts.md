...
1. By default, Micx provides the task suggestions shown in every empty session.
...
5. Members covered by that policy now see the organization-provided prompts instead of Micx's defaults. Everyone else continues seeing the local Micx suggestions.
