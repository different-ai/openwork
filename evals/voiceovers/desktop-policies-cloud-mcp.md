# desktop-policies-cloud-mcp — Admins edit desktop policies straight from the agent, through Micx Cloud
...
Micx Cloud MCP rail (`/mcp/agent`, `search_capabilities` +
...
1. I'm an org admin and I don't open a dashboard — I ask through Micx Cloud, and capability search comes back with the desktop policy tools.
...
5. A member's Micx picks up the new config on its own, and custom providers are now locked on their desktop.
