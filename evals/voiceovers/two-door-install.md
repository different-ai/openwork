...
1. From the landing page you get the normal Micx app, and on first run it offers a calm choice — three option cards: use Micx Cloud, join your organization with your link, or just get started locally.
...
4. Paste the link and it confirms your team and server, installs the version your organization supports, and launches Micx straight into your team's sign-in — never a default.
