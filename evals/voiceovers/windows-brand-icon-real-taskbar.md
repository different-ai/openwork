...
1. A Windows teammate launches Micx and the stock icon is visible in the real taskbar.
...
4. After closing and relaunching Micx, the branded icon appears from the first visible window.

5. Clearing the organization icon restores the stock Micx icon.
