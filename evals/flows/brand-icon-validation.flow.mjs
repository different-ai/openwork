...
export default {
  ...
  // MICX_EVAL_DAYTONA_SANDBOX is required (not optional, unlike
  ...
  requiredEnv: ["MICX_EVAL_DEN_API_URL", "MICX_EVAL_DEN_TOKEN", "MICX_EVAL_DEN_WEB_URL", "MICX_EVAL_DAYTONA_SANDBOX"],
  steps: [
    {
      name: "setup",
      run: async (ctx) => {
