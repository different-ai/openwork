...
export async function chatStreamContinuity(seed: Seed) {
  ...
  return {
    ...
    runtimeFacts: () => seed.evalIn(app, browserScript(async (workspaceId, engine, providerId, modelId, expectedOrigin) => {
