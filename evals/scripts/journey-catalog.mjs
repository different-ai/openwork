...
const definitions = {
  'side-chat-context.e2e.test.ts': {
    name: 'Ask a side chat about the main conversation', placement: 'local',
    cases: [{ id: 'SIDE-01', engines: ['v1', 'v2'], optIns: ['OPENWORK_EVAL_E2E_TESTS'], example: { placement: '--local', engine: 'v2' } }],
  },
