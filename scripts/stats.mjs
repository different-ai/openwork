...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "micx-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "different-ai/micx"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "micx-download-stats",
  }
