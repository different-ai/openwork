...
export default {
  ...
  "mcp.details": "Details",
  "mcp.select_server": "Select a server",
  "mcp.select_server_hint": "Select a server to review status and config.",
  "mcp.capabilities": "Capabilities",
  "mcp.tools_enabled": "Tools enabled",
  "mcp.oauth_ready": "OAuth ready",
  "mcp.usage_hint": "Use the MCP server name in prompts to target its tools.",
  "mcp.next_steps": "Next steps",
