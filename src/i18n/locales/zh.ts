...
export default {
  ...
  "session.back_to_dashboard": "返回首页",
  ...
  "skills.notion_crm_title": "Notion CRM 增强 Skills",
  "skills.notion_crm_description": "为联系人、管道和跟进添加增强工作流。",
  "skills.notion_crm_card_description": "使用现成的 Skills 丰富 Notion CRM 数据。",
  ...
  "skills.import_host_only": "Skills 导入仅在主机模式下可用。",
  "skills.select_skill_folder": "选择 skills 文件夹",
