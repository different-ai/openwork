        ...
        <div class="bg-zinc-900 border border-zinc-800/70 w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden">
          <div class="p-6">
            <div class="flex items-start justify-between gap-4">
              <div>
                <h3 class="text-lg font-semibold text-white">{translate("templates.modal_title")}</h3>
                <p class="text-sm text-zinc-400 mt-1">{translate("templates.modal_description")}</p>
              </div>
            ...
            <div class="mt-6 space-y-4">
              ...
              <label class="block">
                <div class="mb-1 text-xs font-medium text-neutral-300">{translate("templates.prompt_label")}</div>
                <textarea
                ...
                />
                <div class="mt-1 text-xs text-neutral-500">{translate("templates.prompt_hint")}</div>
              </label>
            </div>
