# Eval run 2026-07-15T02-21-34-542Z

- Started: 2026-07-15T02:21:34.542Z
...
- ✅ Prepare the isolated Den and OAuth MCP server (353ms)
  - Assertion: Visible text includes "Add a connection" (passed)
- ✅ Requirements discovery is visible and side-effect free (394ms)
...
- ✅ DCR and PKCE return through the shared callback (458ms)
  - Assertion: Visible text includes "OAuth conformance mrlgeyez" (passed)
...
- ✅ The normalized connection contract reports the shared callback (1825ms)
...
- ✅ The authorized tool is usable from UI and the agent MCP surface (362ms)
...
- ✅ Clean up the proof connection and mock server (11ms)
