...
- `/ee/apps/den-api/`: Den control plane API that provisions/spins up worker runtimes.
...
- `/ee/apps/den-api/` is the cloud control plane API (auth/session + worker CRUD + provisioning orchestration).
