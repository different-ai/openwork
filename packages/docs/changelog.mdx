...
<Update label="March 12th" tags={["🐛 Bug Fixes", "🚀 New Features", "🏗️ Refactoring"]}>
  ...
  <img src="/images/den-landing-page.png" alt="Den landing page showing always-on AI workers for teams" />
  

</Update>

<Update label="March 11th" tags={["🚀 New features", "🐛 Bug Fixes"]}> Improved workers, sharing skills, GOAuth

  ## [v0.11.140](https://github.com/different-ai/openwork/compare/v0.11.136...v0.11.140): 
  ...
  <table>
    <tr>
      <td>
        <video controls className="w-full aspect-video rounded-xl" src="/images/improved-skills-march11th.mp4">
        </video>
        <p><em>New worker opens on an empty session</em></p>
      </td>
      <td>
        <img src="/images/google-auth.png" alt="Google auth flow in the provider auth modal" />
        <p><em>Google auth</em></p>
      </td>
    </tr>
  </table>
