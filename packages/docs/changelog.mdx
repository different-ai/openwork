...
---
<Update label="September 24th" tags={["🚀 New Features"]}>

  ## [v0.18.52](https://github.com/different-ai/openwork/compare/v0.18.51...v0.18.52): Admins can manage plugins and add any MCP server

  - **Find plugins by name or access.** For admins: Manage › Plugins now lets you search by plugin name and filter by team or user, instead of showing one unfiltered list that stopped at the first 100 plugins.
  - **Add any MCP server.** For admins: add a server from the Add a connector page, or paste its URL into the search to start adding it.
