---
title: "Changelog"
description: "OpenWork release notes: new features, improvements, and bug fixes."
"og:description": "OpenWork release notes: new features, improvements, and bug fixes."
---
<Update label="September 25th" tags={["🚀 New Features", "🐛 Bug Fixes"]}>

  ## [v0.18.54](https://github.com/different-ai/openwork/compare/v0.18.52...v0.18.54): Enterprise sign-in and version pinning are back, plus Amazon Bedrock and model shortcuts
