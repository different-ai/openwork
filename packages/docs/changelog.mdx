...
title: "Changelog"
---
<Update label="September 10th" tags={["🐛 Bug Fixes", "🏗️ Refactoring"]}>

  ## [v0.18.46](https://github.com/different-ai/openwork/compare/v0.18.45...v0.18.46): Enterprise updates and policy plugins stay safely scoped

  - Managed policy engine plugins are unregistered cleanly.
  - The updater stays inactive until enterprise activation.
  - The compose evaluation stack stays pinned to the 0.18.45 images.
