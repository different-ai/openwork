...
<Update label="September 22nd" tags={["🚀 New Features", "🐛 Bug Fixes", "🏗️ Refactoring"]}>
  ...
  ## [v0.18.50](https://github.com/different-ai/openwork/compare/v0.18.49...v0.18.50): Preview worlds resume reliably and connection setup stays actionable

  - Warm sandbox preview links now open reliably.
  - Running ACME worlds can resume with AI Gateway enabled, and full worlds can launch with revealed outputs.
  - Chat connection questions stay actionable with a native connection card.
  - OpenWork now supports a self-hosted web server command and agent gateway skill discovery.
