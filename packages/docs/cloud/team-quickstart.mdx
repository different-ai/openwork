...
description: "Create an org on Micx Cloud, invite teammates into teams, publish a plugin with a skill to a marketplace, and trigger it from the desktop app"
---
...
1. Created an organization on Micx Cloud.
...
5. Signed in to the org from the Micx desktop app and triggered the skill with a plain-language prompt.
...
Head to [app.openworklabs.com](https://app.openworklabs.com). Enter your work email and press **Next** — Micx routes you to the right sign-in step automatically.

<Frame>
  ![Start using Micx — email step](/images/cloud-team-quickstart/01-signin-email.png)
</Frame>
...
Right after sign-up, Micx asks you to **name your team**. This creates your organization — you can rename it later, and no credit card is required.
...
Open **Extensions → Plugins**. You'll see Micx's built-in plugins; click **Create plugin** to add your own.
...
In the **Share** section, keep *Share with everyone in the organization* checked and pick your **Marketplace** — this is what publishes the plugin so members find it in the Micx app. Click **Create plugin**.
...
Changing workspace access is sensitive, so Micx asks you to confirm your password first:
...
Now switch to the [Micx desktop app](https://openworklabs.com). On the welcome screen, click **Joining a team? Sign in** and sign in with the same account.
...
Micx shows what your org gives you access to — including your marketplaces:
