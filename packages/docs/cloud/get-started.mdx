...
<div style={{ border: "1px solid #e5e7eb", borderRadius: "20px", padding: "12px", background: "#ffffff" }}>
  <img
    src="/images/cloud-org-settings.png"
    alt="OpenWork Cloud org settings with organization identity, allowed email domains, and desktop restrictions"
