...
<div className="docs-intro">
  <p className="docs-eyebrow">OpenWork Cloud</p>
  <h1>Bring OpenWork to your team.</h1>
  <p className="docs-lead">Share skills, connections, policies, and workflows while keeping access under your control.</p>
  <div className="docs-actions">
    <a href="https://app.openworklabs.com/">Open in browser</a>
    <a href="/cloud/team-quickstart">Team quickstart</a>
  </div>
</div>
