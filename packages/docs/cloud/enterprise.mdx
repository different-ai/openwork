---
title: "Enterprise"
description: "Deploy Micx on your own infrastructure"
---

Want to run Micx on your own infra? We'll help you get there.

Micx can be deployed inside your VPC or on-prem, with SSO, audit logs, and controls over which models and tools your team can use. If you're exploring a self-hosted or private-cloud rollout, talk to us.
