---
title: "OpenWork MCP Gateway: one MCP server for Claude Code, Codex, Cursor, and any MCP client"
...
Just want the one-line setup? See [Add OpenWork MCP to Claude Code, Codex, Cursor and more](/start-here/connect-openwork-mcp).
