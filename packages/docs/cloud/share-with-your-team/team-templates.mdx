...
description: "Create reusable workspace templates for teams in Micx Cloud"
---
...
1. Build the workspace locally in the Micx desktop app.
2. Add the skills, MCP servers, commands, agents, and providers the team should start with.
3. Share the setup to your Micx Cloud organization.
