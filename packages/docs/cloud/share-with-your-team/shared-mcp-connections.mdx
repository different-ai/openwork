...
For Jira and Confluence, follow [Connect Atlassian to OpenWork](/cloud/share-with-your-team/connect-atlassian-mcp)
to configure Atlassian's required OAuth domain allowance before members sign in.
