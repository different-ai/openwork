...
description: "Create a custom provider definition in Micx Cloud and import it into the desktop app"
---
...
<Frame>
  ![Custom LLM provider detail in Micx Cloud](/images/cloud-custom-llm-provider-detail.png)
</Frame>
...
```json
{
  ...
  "doc": "https://infron.ai/docs/frameworks-and-integrations/micx",
...
<Frame>
  ![DeepSeek V3.2 via Infron in the Micx Chat model picker](/images/infron-model-picker.png)
</Frame>

Pick the model and it's live in the session footer:

<Frame>
  ![Infron · DeepSeek V3.2 selected in an Micx session](/images/infron-model-active.png)
</Frame>
