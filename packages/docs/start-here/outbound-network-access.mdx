...
| `inference.openworklabs.com` | Required for Auto | The OpenWork Gateway that serves Auto, the free starting model, before and after sign-in. | Auto is unavailable; connected providers still work. |
