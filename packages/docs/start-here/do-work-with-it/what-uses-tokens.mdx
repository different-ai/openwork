...
description: "Understand when Micx model usage starts and how to control it."
---

Micx uses model tokens when a member actually runs work. Setup actions do not consume tokens by themselves.
