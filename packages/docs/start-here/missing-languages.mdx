...
description: "See which Micx languages ship today and help us improve them."
---

Micx already ships with a growing set of languages, and we want to keep expanding that list.
...
<Frame>
  <iframe
    ...
    title="Micx missing languages overview"
...
If you want to add a new language to Micx, the basic file changes are:
