---
title: "Micx MCP for ChatGPT"
sidebarTitle: "ChatGPT"
description: "ChatGPT MCP setup for Micx Connect, so ChatGPT Desktop can use your org's shared Micx capabilities through OAuth."
---

The Micx MCP server ([Micx Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables ChatGPT Desktop to use the Micx capabilities your organization has
...
3. Start OAuth from ChatGPT's connection prompt, sign in to Micx, and pick
   the organization ChatGPT should use.

## Switch organizations

Open ChatGPT `Settings > MCP servers`, disconnect or clear the `Micx`
