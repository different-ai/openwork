---
title: "Micx MCP for Codex"
sidebarTitle: "Codex"
description: "Codex MCP setup for Micx Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared connections, skills, and Cloud resources."
---

The Micx MCP server ([Micx Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Codex to use the Micx capabilities your organization has made
