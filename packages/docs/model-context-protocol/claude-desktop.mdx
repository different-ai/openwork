---
title: "Micx MCP for Claude Desktop"
sidebarTitle: "Claude Desktop"
description: "Claude Desktop MCP setup for Micx Connect, using custom connectors or mcp-remote to reach your org's shared capabilities."
---

The Micx MCP server ([Micx Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Desktop to use the Micx capabilities your organization has
...
3. Name it `Micx` and set the URL to:
...
Micx accepts. Restart Claude Desktop after editing the config.
