---
title: "Micx MCP for Windsurf"
sidebarTitle: "Windsurf"
description: "Windsurf MCP setup for Micx Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The Micx MCP server ([Micx Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Windsurf to use the Micx capabilities your organization has made
...
Remove the stored MCP auth token for `micx`, then restart the server and
