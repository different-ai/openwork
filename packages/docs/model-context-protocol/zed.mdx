---
title: "Micx MCP for Zed"
sidebarTitle: "Zed"
description: "Zed MCP setup for Micx Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The Micx MCP server ([Micx Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Zed to use the Micx capabilities your organization has made
