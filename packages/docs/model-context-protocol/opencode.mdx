---
title: "Micx MCP for OpenCode"
sidebarTitle: "OpenCode"
description: "OpenCode MCP setup for Micx Connect, Micx's hosted MCP server for Gmail, Calendar, Drive, shared connections, skills, and Cloud resources."
---

The Micx MCP server ([Micx Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables OpenCode to use the Micx capabilities your organization has made
...
<Note>
OpenCode is the verified Micx Connect client. Native remote MCP OAuth passed
...
- Connect from an SSH host with
  [Micx MCP on a remote machine](/cloud/run-in-the-cloud/connect-micx-mcp-remote-machine).
