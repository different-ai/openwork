...
When effective dashboard enablement is removed, eligible hosted admins see OpenWork Models again; existing single-org custom-provider behavior remains. This UI change neither cancels nor creates a subscription and does not revoke Models or Gateway keys.
