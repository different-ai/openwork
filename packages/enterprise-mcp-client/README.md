# `@micx/enterprise-mcp-client`

Reference implementation for server-side remote MCP consumption in Micx.
...
not change local/direct engine MCP, the incoming Micx Cloud meta-MCP,
