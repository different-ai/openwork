...
export type EnterpriseMcpCatalogErrorCode =
  ...
  | "MCP_CATALOG_TOOL_ROUTING_HEADER_INVALID"
  | "MCP_CATALOG_SCHEMA_SIZE_LIMIT"
  | "MCP_CATALOG_SCHEMA_DEPTH_LIMIT"
  | "MCP_CATALOG_SCHEMA_CYCLE"
  | "MCP_CATALOG_SCHEMA_NODE_LIMIT"
  | "MCP_CATALOG_SCHEMA_COMPOSITION_LIMIT"
  | "MCP_CATALOG_SCHEMA_EXTERNAL_REFERENCE"
  | "MCP_CATALOG_SCHEMA_REFERENCE_UNRESOLVED"
  | "MCP_CATALOG_SCHEMA_REFERENCE_CYCLE"
  | "MCP_CATALOG_SCHEMA_REFERENCE_DEPTH_LIMIT"
