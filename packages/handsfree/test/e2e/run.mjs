...
const HELPER_APP = process.env.MICX_COMPUTER_USE_HELPER
  ?? join(repoRoot, "apps/desktop/resources/helpers/Micx Computer Use.app");
...
try { execSync(`pkill -f 'Micx Computer Use.app'`); } catch {}
