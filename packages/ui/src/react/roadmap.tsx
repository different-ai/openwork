...
export const roadmapSections: RoadmapSection[] = [
  {
    ...
    description:
      "The desktop app is the main Micx experience. It is where people work with files, run agents, manage sessions, create skills, connect services, and customize a workspace.",
    callout:
      "The desktop app is where most people configure Micx today. Connect is how that configuration travels.",
    items: [
      {
  ...
  },
  {
    ...
    description:
      "What you configure in Micx should not stay trapped in one interface. Micx Connect brings the same capabilities into the agents you already use.",
    items: [
      {
        title: "Micx Connect MCP",
      ...
      },
      {
        ...
        description: "Use Micx from compatible agents without rewriting skills or changing MCP servers.",
        status: "live",
      },
      {
  ...
  },
  {
    ...
    description:
      "Micx Cloud is the control plane for distributing capabilities, applying desktop policies, managing identity and access, and understanding adoption across the organization.",
    callout:
      "Configure policies and access once in Micx Cloud. The desktop app and Micx Connect apply them for each member and team.",
    items: [
      {
      ...
      },
      {
        ...
        description: "Import Claude-compatible plugin and marketplace manifests and normalize their skills, MCPs, commands, and tools into Micx extensions.",
        status: "live",
      },
      {
        title: "SAML SSO",
      ...
      },
      {
        ...
        description: "Extend OTLP traces, metrics, and logs across Micx services and deployment paths.",
        status: "building",
      },
    ],
  },
  ...
  },
  {
    ...
    title: "Micx on every surface",
    description:
      "The desktop app remains the richest Micx experience. Other surfaces provide focused ways to reach the same capabilities, permissions, workspaces, and history.",
    items: [
      {
        title: "Micx desktop",
      ...
      },
      {
        ...
        description: "Bring Micx into the coding and agent tools you already use.",
        status: "live",
      },
      {
        title: "Slack",
      ...
      },
      {
        ...
        description: "Reach Micx from more of the places where requests and decisions arrive.",
        status: "exploring",
      },
      {
        title: "Custom organization agents",
        description: "Build specialized surfaces on top of the same Micx workspace and capability system.",
        status: "exploring",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "Keep agent context small while making the full Micx capability catalog available on demand.",
        status: "live",
      },
      {
...
export function MicxRoadmap({
  feedbackHref = "https://micxlabs.com/feedback?source=roadmap",
  docsHref = "https://micxlabs.com/docs",
}: {
  feedbackHref?: string
  docsHref?: string
}) {
  ...
  return (
    <div data-testid="micx-roadmap" className="text-[#011627]">
      <section className="pb-14 pt-10 md:pb-20 md:pt-16">
        ...
        <div className="mt-8 grid gap-6 text-base leading-7 text-slate-600 md:grid-cols-2 md:text-lg md:leading-8">
          <p>
            Most people use Micx through the desktop app today. It is where you create a workspace, work with files, connect services, add skills, and customize how your agent works.
          </p>
          <p>
            What you create there should not stay trapped there. Micx Connect already brings the same capabilities into compatible agents. Next come persistent hosted workspaces, Slack, mobile, and more.
          </p>
        </div>
      ...
      <section className="py-16 text-center md:py-24">
        <div className="mx-auto max-w-2xl">
          ...
          <h2 className="mt-4 text-3xl font-medium tracking-[-0.035em] sm:text-4xl md:text-5xl">what should Micx build next?</h2>
