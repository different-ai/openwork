...
export default {
  ...
  // ==================== Skills ====================
  "skills.title": "Skills",
  "skills.subtitle": "Skills 是独立的，来自工作区，并在聊天会话中运行。",
  "skills.refresh": "刷新",
  "skills.add_title": "添加 skills",
  "skills.add_description": "使用预置技能或从 git 只读导入。",
  "skills.skill_creator_title": "Skill Creator",
  "skills.skill_creator_description": "安装 Skill Creator 指南，在聊天中创建新技能。",
  "skills.install_skill_creator": "安装 skill-creator",
  "skills.git_title": "从 git 导入",
  "skills.git_description": "粘贴仓库链接，OpenWork 会复制 `.opencode/skills` 或 `.claude/skills`。",
  "skills.git_placeholder": "https://github.com/different-ai/notion-crm-enrichment/tree/main",
  "skills.git_import": "导入",
  "skills.git_hint": "只读克隆，已存在的技能会跳过。",
  "skills.reveal_title": "显示 skills 文件夹",
  "skills.reveal_description": "打开工作区 skills 文件夹以手动添加文件。",
  "skills.reveal_button": "在 Finder 中显示",
  "skills.reveal_button_windows": "打开文件夹",
  "skills.use_title": "在聊天中使用",
  "skills.use_description": "Skills 在聊天会话里通过 `skill` 工具运行。",
  "skills.use_button": "打开聊天",
  ...
  "skills.repo_required": "请输入 git 仓库链接。",
  ...
  "skills.importing_repo": "正在从 git 导入 skills...",
  "skills.import_complete": "Skills 已导入。",
