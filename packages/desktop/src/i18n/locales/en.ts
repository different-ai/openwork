...
export default {
  ...
  // ==================== Skills ====================
  "skills.title": "Skills",
  "skills.subtitle": "Skills are standalone and run in chat sessions from your workspace.",
  "skills.refresh": "Refresh",
  "skills.add_title": "Add skills",
  "skills.add_description": "Add a predefined skill or import from git read-only.",
  "skills.skill_creator_title": "Skill Creator",
  "skills.skill_creator_description": "Seed the skill-creator guide so you can author new skills in chat.",
  "skills.install_skill_creator": "Install skill-creator",
  "skills.git_title": "Import from git",
  "skills.git_description": "Paste a repo link; OpenWork copies `.opencode/skills` or `.claude/skills` from the repo.",
  "skills.git_placeholder": "https://github.com/different-ai/notion-crm-enrichment/tree/main",
  "skills.git_import": "Import",
  "skills.git_hint": "Read-only clone. Existing skills are skipped.",
  "skills.reveal_title": "Reveal skills folder",
  "skills.reveal_description": "Open the workspace skills folder to add files manually.",
  "skills.reveal_button": "Reveal in Finder",
  "skills.reveal_button_windows": "Open folder",
  "skills.use_title": "Use skills in chat",
  "skills.use_description": "Skills run inside chat sessions using the `skill` tool.",
  "skills.use_button": "Open chat",
  ...
  "skills.repo_required": "Enter a git repository URL.",
  ...
  "skills.importing_repo": "Importing skills from git...",
  "skills.import_complete": "Skills imported.",
  "skills.import_failed": "Import failed.",
  "skills.reveal_failed": "Failed to reveal skills folder.",
