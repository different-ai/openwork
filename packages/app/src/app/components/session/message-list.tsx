              ...
              >
                <div
                  class={`w-full relative ${
                    block.isUser
                      ? "max-w-[80%] px-5 py-3 rounded-[24px] bg-[#f0f0f0] text-slate-800 text-[14px] leading-relaxed font-medium"
                      : "max-w-[650px] text-[15px] leading-[1.65] text-slate-800 font-serif antialiased group"
                  } ${searchOutlineClass}`}
                >
                  <StepsContainer
                    id={block.id}
