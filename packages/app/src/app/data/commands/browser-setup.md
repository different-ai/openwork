---
name: browser-setup
description: Guide the user through browser automation setup in AikaOS
---

Help the user set up browser automation in AikaOS.
...
1) Are you using the AikaOS desktop app, or the web app?
...
2) If they want the OpenCode Browser path:
   - Tell them where to check in AikaOS (Plugins tab) and what "connected" looks like.
