...
export default {
  ...
  "skills.remote_title": "远程 skills",
  "skills.remote_description": "从 GitHub 浏览 skills，无需先安装。",
  "skills.remote_source_label": "GitHub 源",
  "skills.remote_add_source": "添加源",
  "skills.remote_remove": "移除",
  "skills.remote_no_sources": "添加一个 GitHub 源以查看远程 skills。",
  "skills.remote_no_skills": "该源未找到 skills。",
  "skills.remote_loading": "加载中...",
  "skills.remote_installing": "正在安装...",
  "skills.remote_source_required": "先输入 GitHub 源。",
  "skills.remote_source_invalid": "请输入有效的 GitHub 源。",
  "skills.remote_source_exists": "该源已添加。",
  "skills.remote_repo_not_found": "未找到 GitHub 仓库。",
  "skills.remote_rate_limited": "GitHub 速率限制已触发，请稍后再试。",
  "skills.remote_fetch_failed": "加载远程 skills 失败。",
  "skills.remote_host_required": "浏览和安装远程 skills 需要 OpenWork 服务器。",
