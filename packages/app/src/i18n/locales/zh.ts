...
export default {
  ...
  "language.changed_title": "语言已更改",
  "language.changed_description": "重启应用以将语言更改应用到所有菜单和界面元素。",
  "language.restart_now": "立即重启",
  "language.restart_later": "稍后",
  ...
  "settings.appearance_advanced_hint": "自定义窗口外观。",
  "settings.hide_titlebar": "隐藏标题栏",
  "settings.hide_titlebar_hint": "隐藏窗口标题栏。对 Linux 上的平铺窗口管理器（如 Hyprland, i3, sway）非常有用。",
