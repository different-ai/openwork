...
export default {
  ...
  "sidebar.no_workspaces": "此会话中尚无工作区。添加一个以开始使用。",
  "sidebar.sandbox": "沙盒",
  "sidebar.remote": "远程",
  "sidebar.switch": "切换",
  "sidebar.active": "活跃",
  "sidebar.expand": "展开",
  "sidebar.collapse": "收起",
  "sidebar.drag_to_reorder": "拖动以重新排序",
  "sidebar.needs_attention": "需要关注",
  "sidebar.edit_connection": "编辑连接",
  "sidebar.test_connection": "测试连接",
  "sidebar.stop_sandbox": "停止沙盒",
  "sidebar.remove": "移除",
  "sidebar.no_sessions": "尚无会话。",
  "sidebar.show_fewer": "显示更少",
  ...
  "context.none_yet": "还没有。",
  "context.plugins": "插件",
  "context.no_plugins": "未加载插件。",
  "context.mcp": "MCP",
  "context.no_mcp": "未加载 MCP 服务器。",
  "context.no_mcp_servers": "未加载 MCP 服务器。",
  "context.skills": "Skills",
  "context.no_skills": "未加载 skills。",
  "context.authorized_folders": "已授权文件夹",
  "context.inbox": "收件箱",
  "context.inbox_label": "收件箱",
  "context.no_inbox_files": "还没有收件箱文件。",
  "context.artifacts": "工件",
  "context.no_artifacts": "还没有工件。",
  "context.drop_files": "拖放文件或点击上传",
  "context.uploading": "正在上传...",
  "context.refresh_inbox": "刷新收件箱",
  "context.connect_to_see": "连接以查看收件箱文件。",
  "context.share_files_hint": "与您的远程工作区共享文件。",
  "context.failed_load_inbox": "加载收件箱失败",
  "context.uploaded_to_inbox": "已上传到工作区收件箱。",
  "context.inbox_upload_failed": "收件箱上传失败",
  "context.copied": "已复制",
  "context.copy_failed": "复制失败。您的浏览器可能阻止了剪贴板访问。",
  "context.connect_to_download": "连接到工作区以下载收件箱文件。",
  "context.missing_inbox_id": "缺少收件箱项目 ID。",
  "context.inbox_helper_text": "与您的远程工作区共享文件。",
  "context.inbox_load_failed": "加载收件箱失败",
  "context.inbox_connect_to_upload": "连接到工作区以上传收件箱文件。",
  "context.inbox_uploading": "正在上传 {label}...",
  "context.inbox_uploaded": "已上传到工作区收件箱。",
  "context.inbox_drop_files_title": "拖放文件到此处上传",
  "context.inbox_drop_files_title_disconnected": "连接到工作区以上传",
  "context.inbox_drop_files_label": "拖放文件或点击上传",
  "context.inbox_uploading_label": "正在上传...",
  "context.inbox_copied": "已复制: {path}",
  "context.inbox_copy_failed": "复制失败。您的浏览器可能阻止了剪贴板访问。",
  "context.inbox_connect_to_download": "连接到工作区以下载收件箱文件。",
  "context.inbox_missing_id": "缺少收件箱项目 ID。",
  "context.inbox_download_failed": "下载失败",
  "context.show_fewer": "显示更少",
  "context.show_more": "显示更多 {count} 个",
  "context.artifacts_label": "工件",
  "context.markdown_badge": "MD",
  "context.image_badge": "IMG",
  "context.open_in_obsidian": "在 Obsidian 中打开",
  "context.reveal_image_in_finder": "在 Finder 中显示图片",
  "context.reveal_file_in_finder": "在 Finder 中显示文件",
  "context.reveal_button": "显示",
  "context.status_disabled": "已禁用",
  "context.status_disconnected": "未连接",
  "context.status_connected": "已连接",
  "context.status_needs_auth": "需要认证",
  "context.status_register_client": "注册客户端",
  "context.status_failed": "失败",
  ...
  "skills.load_failed": "加载 skill 失败。",
  "skills.invalid_bundle_error": "此链接不是 OpenWork skill bundle",
  "skills.missing_name_error": "Bundle 缺少 skill 名称",
  "skills.missing_content_error": "Bundle 缺少 skill 内容",
  ...
  "mcp.no_servers_configured": "还没有配置 MCP 服务器。",
  "mcp.failed_to_load": "加载 MCP 服务器失败。",
  "mcp.server_unavailable_readonly": "OpenWork 服务器不可用。MCP 配置为只读。",
  "mcp.server_unavailable_auth_readonly": "OpenWork 服务器不可用。MCP 认证为只读。",
  ...
  // ==================== Scheduled Tasks ====================
  "scheduled.modal_folder_placeholder": "选择文件夹",
  ...
  "error.not_connected": "未连接到服务器",
  "error.provider_id_required": "需要提供程序 ID",
  "error.oauth_method_required": "需要 OAuth 方法",
  "error.api_key_required": "需要 API 密钥",
  "error.provider_auth_in_progress": "提供程序认证已在进行中。",
  "error.select_worker_first": "请先选择一个工作区。",
  "error.local_host_not_ready": "本地 OpenWork 主机尚未就绪。",
  "error.base64_encoder_unavailable": "Base64 编码器不可用",
  "error.base64_decoder_unavailable": "Base64 解码器不可用",
  "error.connect_to_sync_remote_files": "连接到 OpenWork 服务器以同步远程文件。",
  "error.openwork_client_unavailable": "OpenWork 服务器客户端不可用",
  "error.obsidian_worker_relative_only": "只能在 Obsidian 中打开与工作区相关的文件。",
  "error.share_links_openwork_only": "分享服务链接仅适用于 OpenWork 工作区。",
  "error.host_url_token_required": "需要提供 OpenWork 主机地址和令牌。",
  "error.resolve_worker_local_failed": "无法在本地 OpenWork 主机上解析此工作区。",
  "error.resolve_worker_failed": "无法在 OpenWork 主机上解析此工作区。",
  "error.no_skills_in_workspace": "此工作区中未找到技能。",
  ...
  // ==================== Soul ====================
  "soul.focus_placeholder": "为远程工作者交付 Soul UI",
  "soul.boundaries_placeholder": "保持心跳简洁且非破坏性",

  // ==================== Identities ====================
  "identities.bot_token_placeholder": "粘贴来自 @BotFather 的 Telegram 机器人令牌",
  "identities.slack_bot_token_placeholder": "xoxb-...",
  "identities.slack_app_token_placeholder": "xapp-...",
  "identities.agent_placeholder": "在此处添加 opencodeRouter 的消息行为说明...",
  "identities.peer_id_placeholder_telegram": "Telegram 聊天 ID（例如：123456789）",
  "identities.peer_id_placeholder_slack": "Slack peer ID（例如：D12345678|thread_ts）",
  ...
  "proto.doc": "Doc",
  "proto.choose_folder_placeholder": "选择文件夹",
  "proto.search_skills_placeholder": "搜索技能",
  "proto.ask_codex_placeholder": "向 Codex 提问...",
  "proto.reconcile_vendor_overages": "核对供应商超额费用",
  "proto.generate_qa_report": "生成 QA 报告",
  "proto.sync_policy_checklist": "同步政策清单",
  "proto.draft_task_placeholder": "起草要运行的任务...",
  "proto.describe_task_placeholder": "描述任务...",
} as const;
