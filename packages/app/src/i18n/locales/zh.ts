...
export default {
  ...
  "dashboard.openwork_host_token_label": "访问令牌（可选）",
  "dashboard.openwork_host_token_placeholder": "粘贴你的令牌",
  "dashboard.openwork_host_token_hint": "仅保存在本地。用于访问此主机。",
  "dashboard.remote_mode_openwork": "OpenWork 主机",
  "dashboard.remote_mode_direct": "OpenCode 直连",
  ...
  "onboarding.remote_workspace_title": "连接到 OpenWork 主机",
  "onboarding.remote_workspace_description": "使用 OpenWork 提供的主机地址和令牌。",
  "onboarding.remote_workspace_action": "连接",
  "onboarding.remote_workspace_card_title": "连接到主机",
  "onboarding.remote_workspace_card_description": "配对 OpenWork 主机，或直接连接 OpenCode 引擎。",
