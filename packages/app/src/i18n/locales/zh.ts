...
export default {
  ...
  "mcp.auth.already_connected_title": "已连接",
  ...
  "settings.model_description_session_short": "为您的下一条消息选择模型。",
  "settings.change": "更改",
  "settings.engine_bundled": "内置（推荐）",
  "settings.windows_bundle_unavailable": "Windows 尚不支持内置引擎",
  "settings.windows_bundle_unavailable_notice": "内置引擎目前在 Windows 上不可用。",
  "settings.engine_source_notice": "内置引擎是最可靠的选择。仅当您自己管理 OpenCode 时才使用系统安装。",
  "settings.cache_requires_desktop": "缓存修复需要桌面应用",
  ...
  "settings.done": "完成",
  "settings.demo_mode_short": "演示模式",
  "settings.demo_mode_description_short": "用于记录和审查的轻量级脚本状态。",
  "settings.enable_demo_mode_short": "启用演示模式",
  "settings.enable_demo_mode_description_short": "用演示序列替换实时数据。",
  "settings.demo_cold_open": "冷启动",
  "settings.demo_scheduler": "调度器",
  "settings.demo_summaries": "摘要",
  "settings.demo_groceries": "购物清单",
  "settings.demo_sequences_notice_short": "演示序列将替换为编排的会话、工件和工作区上下文。",
  "settings.updates_short": "更新",
  "settings.updates_description_short": "保持 OpenWork 为最新版本。",
  "settings.automatic_checks_short": "自动检查",
  "settings.automatic_checks_description_short": "每天一次（安静）",
  ...
  "settings.advanced_short": "高级",
  "settings.advanced_description_legacy": "重置 OpenWork 本地状态以重新测试入门流程。",
  "settings.reset_onboarding_short": "重置入门",
  ...
  "settings.language_description": "选择界面的首选语言。",
  ...
  "settings.theme_system_notice": "系统模式自动跟随您的操作系统偏好。",
  "settings.appearance_description": "匹配系统或强制浅色/深色模式。",
  ...
  "settings.reset_startup_mode": "重置默认启动模式",
  "settings.reset_startup_notice": "这将清除您保存的偏好设置，并在下次启动时显示模式选择。",
  "settings.advanced_title": "高级",
  "settings.advanced_hint": "重置 OpenWork 本地状态以重新测试入门流程。",
  "settings.advanced_description": "引擎和重置操作的高级选项。",
  ...
  "onboarding.workspace_selector.starter_workspace": "入门工作区",
  "onboarding.workspace_selector.starter_workspace_desc": "预先配置，向您展示如何使用插件、模板和技能。",
  "onboarding.workspace_selector.empty_workspace": "空工作区",
  "onboarding.workspace_selector.empty_workspace_desc": "从空白文件夹开始，根据需要添加内容。",
  "onboarding.workspace_selector.select_folder": "选择文件夹",
  "onboarding.workspace_selector.choose": "选择",
  "onboarding.workspace_selector.opening": "正在打开...",
  "onboarding.workspace_selector.choose_preset": "选择预设",
