...
export default {
  ...
  "dashboard.hero_description": "目標を記述してください。OpenWorkが実行し、監査証跡を保持します。",
  "dashboard.quick_start_commands": "クイックスタート コマンド",
  "dashboard.view_all": "すべて表示",
  "dashboard.no_commands": "まだ コマンド がありません。スターターコマンドがここに表示されます。",
  "dashboard.run_command": "保存済みコマンドを実行",
  "dashboard.recent_sessions": "最近の セッション",
  "dashboard.this_workspace": "このワーカー",
  "dashboard.no_sessions": "まだ セッション がありません。",
  "dashboard.idle": "アイドル",
  ...
  "dashboard.create_workspace_subtitle": "新しいフォルダベースのワーカーを初期化します。",
  "dashboard.create_workspace_confirm": "ワーカーを作成",
  "dashboard.create_sandbox_confirm": "サンドボックスとして作成",
  "share_skill_destination.title": "この スキル をどこに追加しますか？",
  "share_skill_destination.subtitle": "共有された スキル をインポートする前に、既存のワーカーを選択するか新しいワーカーを作成してください。",
  "share_skill_destination.skill_label": "共有 スキル",
  "share_skill_destination.fallback_skill_name": "共有 スキル",
  ...
  "share_skill_destination.no_workers": "まだ準備できたワーカーがありません。この スキル をインストールするには、ワーカーを作成するかリモートワーカーに接続してください。",
  ...
  "share_skill_destination.confirm_button": "ワーカーに スキル を追加",
  "share_skill_destination.confirm_busy": "スキル を追加中...",
  ...
  "share_skill_destination.create_worker_desc": "ワーカーセットアップフローを開き、新しいワーカーの準備ができたらこの スキル を追加します。",
  "share_skill_destination.connect_remote": "リモートワーカーに接続",
  "share_skill_destination.connect_remote_desc": "OpenWorkホストを接続し、リストから選択してこの スキル をインポートします。",
  "dashboard.sandbox_get_ready_title": "サンドボックスにはDockerが必要です",
  "dashboard.sandbox_get_ready_action": "システムを準備する",
  "dashboard.sandbox_get_ready_desc": "このワーカーを隔離されたDockerコンテナで実行し、より安全で再現性の高い実行を行います。",
  ...
  "dashboard.remote_workspace_hint": "OpenWorkサーバーを追跡し、いつでも再接続できます。",
  ...
  "dashboard.remote_directory_hint": "空白のままにするとサーバーのデフォルトが使用されます。",
  ...
  "dashboard.choose_folder_next": "ワーカーとファイルを共有します。",
  "dashboard.change": "変更",
  ...
  "dashboard.starter_workspace_desc": "プラグイン、コマンド、スキル の使い方を示す設定済みワーカーです。",
  ...
  "dashboard.blueprints_workspace_desc": "再利用可能な スキル、コマンド、共有フローに対応した自動化対応ワーカーです。",
  ...
  // ==================== Session ====================
  "session.no_selected": "セッション が選択されていません",
  ...
  "session.ready_to_work_description": "タスクを記述してください。進行状況を表示し、必要に応じて権限を確認します。",
  "session.document_label": "ドキュメント",
  "session.standard_label": "スタンダード",
  "session.no_artifacts_fallback": "まだアーティファクトがありません。",
  "session.active_plugins_label": "アクティブな プラグイン",
  "session.active_plugins_count": "{count}",
  "session.no_plugins_loaded": "プラグイン が読み込まれていません。",
  ...
  "session.permission_required_description": "OpenCodeが続行するために権限をリクエストしています。",
  ...
  "session.ready_description": "タスクを記述してください。進行状況を表示し、必要に応じて権限を確認します。",
  ...
  "session.model": "モデル",
  "session.ready": "準備完了",
  "session.connect_provider": "プロバイダーを接続してカスタマイズしてください。",
  "session.running": "実行中",
  ...
  "session.active_plugins": "アクティブな プラグイン",
  "session.no_plugins": "プラグイン が読み込まれていません。",
  ...
  "session.permission_description": "OpenCodeが続行するために権限をリクエストしています。",
  "session.permission_label": "権限",
  "session.scope_label": "スコープ",
  "session.details": "詳細",
  "session.deny": "拒否",
  "session.once": "一度だけ",
  "session.allow_for_session": "セッション 中許可",
  ...
  "session.rename_title": "セッション 名を変更",
  "session.rename_description": "この セッション の名前を更新します。",
  "session.rename_label": "セッション 名",
  ...
  // ==================== Skills ====================
  "skills.title": "スキル",
  "skills.subtitle": "このワーカーの スキル を管理します。",
  "skills.refresh": "更新",
  "skills.add_title": "スキル を追加",
  "skills.add_description": "スターターコマンドをインストール、スキル をインポート、またはフォルダを開きます。",
  "skills.install_from_openpackage": "OpenPackage からインストール",
  "skills.host_mode_only": "ローカルワーカーのみ",
  "skills.install": "インストール",
  "skills.installed_label": "インストール済み",
  "skills.install_hint": "OpenPackage パッケージを現在のワーカーにインストールします。スキル は `.opencode/skills` に配置されます。",
  "skills.import_local": "ローカル スキル をインポート",
  "skills.import_local_hint": "既存の スキル フォルダをこのワーカーにコピーします。",
  "skills.import": "インポート",
  ...
  "skills.registry_notice": "OpenPackage レジストリへの公開（`opkg push`）には現在認証が必要です。レジストリ検索と厳選リスト同期は今後対応予定です。",
  "skills.installed": "インストール済み スキル",
  "skills.no_skills": "`.opencode/skills`、`.claude/skills`、`~/.agents/skills` に スキル が検出されませんでした。",
  "skills.desktop_required": "スキル 管理にはデスクトップアプリが必要です。",
  "skills.host_only_error": "スキル 管理にはローカルワーカーまたは接続されたOpenWorkサーバーが必要です。",
  "skills.install_skill_creator": "スキル クリエイターをインストール",
  "skills.install_skill_creator_hint": "この スキル を使って、チャット内から他の スキル を作成できます。",
  "skills.installing_skill_creator": "スキル クリエイターをインストール中...",
  "skills.skill_creator_installed": "スキル クリエイターがインストールされました。",
  "skills.skill_creator_already_installed": "スキル クリエイターは既にインストール済みです。",
  "skills.install_failed": "スキル のインストールに失敗しました。",
  "skills.reveal_folder": "スキル フォルダを開く",
  "skills.reveal_folder_hint": "スキル ディレクトリをFinderで開きます。",
  "skills.reveal_button": "Finderで表示",
  "skills.reveal_failed": "スキル フォルダを開けませんでした。",
  "skills.uninstall": "アンインストール",
  "skills.uninstall_title": "スキル をアンインストールしますか？",
  "skills.uninstall_warning": "ワーカーから `{name}` スキル を完全に削除します。",
  "skills.uninstall_failed": "スキル のアンインストールに失敗しました。",
  "skills.uninstalled": "スキル が削除されました。",
  "skills.source_placeholder": "github:anthropics/claude-code",
  "skills.notion_crm_title": "Notion CRM エンリッチメント スキル",
  "skills.notion_crm_description": "連絡先、パイプライン、フォローアップのエンリッチメントワークフローを追加します。",
  "skills.notion_crm_card_description": "既製の スキル で Notion CRM データをエンリッチします。",
  "skills.connect_host_to_load": "スキル を読み込むにはOpenWorkサーバーに接続してください。",
  "skills.pick_workspace_first": "最初にワーカーフォルダを選択してください。",
  "skills.no_skills_found": "まだ スキル が見つかりません。",
  "skills.installed_description": "このワーカーで利用可能な スキル。",
  "skills.failed_to_load": "スキル の読み込みに失敗しました",
  "skills.plugin_management_host_only": "プラグイン 管理にはデスクトップアプリが必要です。",
  "skills.plugins_host_only": "プラグイン はデスクトップアプリでのみ利用可能です。",
  "skills.pick_project_for_plugins": "プロジェクトの プラグイン を管理するにはプロジェクトフォルダを選択してください。",
  "skills.pick_project_for_active": "アクティブな プラグイン を読み込むにはプロジェクトフォルダを選択してください。",
  "skills.no_opencode_found": "opencode.json がまだ見つかりません。プラグイン を追加して作成してください。",
  "skills.no_opencode_workspace": "このワーカーにはまだ opencode.json がありません。",
  "skills.failed_parse_opencode": "opencode.json の解析に失敗しました",
  "skills.failed_load_opencode": "opencode.json の読み込みに失敗しました",
  "skills.failed_load_active": "アクティブな プラグイン の読み込みに失敗しました。",
  "skills.enter_plugin_name": "プラグイン パッケージ名を入力してください。",
  "skills.plugin_already_listed": "プラグイン は既に opencode.json に登録されています。",
  "skills.failed_update_opencode": "opencode.json の更新に失敗しました",
  "skills.opackage_install_host_only": "OpenPackage のインストールにはデスクトップアプリが必要です。",
  "skills.pick_project_first": "最初にプロジェクトフォルダを選択してください。",
  "skills.enter_opackage_source": "OpenPackage ソースを入力してください（例: github:anthropics/claude-code）。",
  "skills.installing_opackage": "OpenPackage をインストール中...",
  "skills.install_complete": "インストール完了。",
  "skills.curated_list_notice": "これは厳選リストであり、OpenPackage ではありません。リンクをコピーするか、予定されているレジストリ検索統合についてPRDをご確認ください。",
  "skills.import_host_only": "スキル のインポートにはデスクトップアプリが必要です。",
  "skills.select_skill_folder": "スキル フォルダを選択",
  "skills.import_failed": "インポートに失敗しました（{status}）",
  "skills.imported": "インポート完了。",
  "skills.unknown_error": "不明なエラー",

  // ==================== Plugins ====================
  "plugins.title": "OpenCode プラグイン",
  "plugins.description": "プロジェクトまたはグローバルの OpenCode プラグイン 用の `opencode.json` を管理します。",
  "plugins.config_label": "設定",
  "plugins.config_not_loaded": "まだ読み込まれていません",
  "plugins.suggested_label": "おすすめの プラグイン",
  "plugins.no_plugins_yet": "まだ プラグイン が設定されていません。",
  ...
  "plugins.suggested": "おすすめの プラグイン",
  "plugins.hide_setup": "セットアップを隠す",
  "plugins.setup": "セットアップ",
  "plugins.added": "追加済み",
  "plugins.add": "追加",
  "plugins.enabled": "有効",
  "plugins.no_plugins": "まだ プラグイン が設定されていません。",
  "plugins.add_label": "プラグイン を追加",
  "plugins.placeholder": "opencode-wakatime",
  "plugins.add_hint": "npm パッケージ名を追加してください（例: opencode-wakatime）",

  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "アプリ",
  "mcp.apps_subtitle": "お気に入りのツールを接続して、OpenWorkがあなたに代わって使えるようにしましょう。",
  "mcp.app_connected": "アプリ接続済み",
  "mcp.apps_connected": "アプリ接続済み",
  "mcp.title": "アプリ",
  "mcp.description": "ワンクリックでツールを接続。",
  "mcp.alpha_banner_title": "アプリは体験を改善中のため、アーリーアクセスです。",
  "mcp.alpha_banner_help": "協力いただける場合は、PRを開いてサインインフローが正常に動作する短いビデオを含めてください。",
  "mcp.mcps_title": "アプリ",
  ...
  "mcp.alpha_warning": "アプリは体験を改善中のため、アーリーアクセスです。",
  "mcp.github_issue": "GitHubのissue #9510を見る",
  "mcp.contribution_guide": "協力いただける場合は、PRを開いてサインインフローが正常に動作する短いビデオを含めてください。",
  ...
  "mcp.config_locations": "設定は opencode.json、opencode.jsonc、または .opencode/opencode.json に配置できます。",
  ...
  "mcp.usage_hint_text": "プロンプトでアプリ名を言及してツールを使用してください。",
  ...
  // Add MCP Modal
  "mcp.add_modal_title": "MCP サーバーを追加",
  ...
  "mcp.auth.configured_previously": "MCPはグローバルまたは前のセッションで設定されている可能性があります。このモーダルを閉じて、すぐにMCPツールの使用を開始できます。",
  ...
  "settings.thinking_description": "シンキングパーツを表示（デベロッパーモードのみ）。",
  "settings.on": "オン",
  "settings.off": "オフ",
  ...
  "settings.advanced_description": "オンボーディングを再テストするためにOpenWorkのローカル状態をリセットします。",
  ...
  "settings.thinking_hint": "シンキングパーツを表示（デベロッパーモードのみ）。",
  ...
  "settings.advanced_hint": "オンボーディングを再テストするためにOpenWorkのローカル状態をリセットします。",
  ...
  "onboarding.verifying": "セキュアなハンドシェイクを確認中",
  "onboarding.create_first_workspace": "最初のワーカーを作成",
  "onboarding.create_workspace": "ワーカーを作成",
  "onboarding.workspace_description": "フォルダとプリセットを選んでワーカーをセットアップしてください。",
  ...
  "onboarding.workspace_folder_label": "ワーカーは独自の スキル、プラグイン、コマンド を持つフォルダです。",
  ...
  "onboarding.welcome_title": "今日はOpenWorkをどのように実行しますか？",
  ...
  "status.loading_session": "セッション を読み込み中",
  ...
  "workspace.switching_subtitle": "最近の作業を復元します。",
  ...
  "app.error.workspace_commands_desktop": "コマンド にはデスクトップアプリが必要です。",
