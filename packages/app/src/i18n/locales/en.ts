...
export default {
  ...
  "session.unknown_command": "Unknown command",
  ...
  "mcp.auth.already_connected_title": "Already Connected",
  ...
  "settings.model_description_session_short": "Choose a model for your next message.",
  "settings.change": "Change",
  "settings.engine_bundled": "Bundled (recommended)",
  "settings.windows_bundle_unavailable": "Bundled engine is not supported on Windows yet",
  "settings.windows_bundle_unavailable_notice": "Bundled engine is currently unavailable on Windows.",
  "settings.engine_source_notice": "Bundled engine is the most reliable option. Use System install only if you manage OpenCode yourself.",
  "settings.cache_requires_desktop": "Cache repair requires the desktop app",
  ...
  "settings.done": "Done",
  "settings.demo_mode_short": "Demo mode",
  "settings.demo_mode_description_short": "Lightweight scripted states for recording and review.",
  "settings.enable_demo_mode_short": "Enable demo mode",
  "settings.enable_demo_mode_description_short": "Replaces live data with demo sequences.",
  ...
  "settings.demo_sequences_notice_short": "Demo sequences swap in scripted sessions, artifacts, and workspace context.",
  "settings.updates_short": "Updates",
  "settings.updates_description_short": "Keep OpenWork up to date.",
  "settings.automatic_checks_short": "Automatic checks",
  "settings.automatic_checks_description_short": "Once per day (quiet)",
  ...
  "settings.advanced_short": "Advanced",
  "settings.advanced_description_legacy": "Reset OpenWork local state to retest onboarding.",
  "settings.reset_onboarding_short": "Reset onboarding",
  ...
  "settings.theme_system_notice": "System mode follows your OS preference automatically.",
  "settings.appearance_description": "Match the system or force light/dark mode.",
  ...
  "settings.reset_startup_mode": "Reset default startup mode",
  "settings.reset_startup_notice": "This clears your saved preference and shows mode selection on next launch.",
  "settings.advanced_title": "Advanced",
  "settings.advanced_hint": "Reset OpenWork local state to retest onboarding.",
  "settings.advanced_description": "Power options for the engine and reset actions.",
  ...
  "onboarding.workspace_selector.starter_workspace": "Starter workspace",
  "onboarding.workspace_selector.starter_workspace_desc": "Preconfigured to show you how to use plugins, templates, and skills.",
  "onboarding.workspace_selector.empty_workspace": "Empty workspace",
  "onboarding.workspace_selector.empty_workspace_desc": "Start with a blank folder and add what you need.",
  "onboarding.workspace_selector.select_folder": "Select Folder",
  "onboarding.workspace_selector.choose": "Choose",
  "onboarding.workspace_selector.opening": "Opening...",
  "onboarding.workspace_selector.choose_preset": "Choose Preset",
