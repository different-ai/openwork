...
export default {
  ...
  "dashboard.openwork_host_token_label": "Access token (optional)",
  "dashboard.openwork_host_token_placeholder": "Paste your token",
  "dashboard.openwork_host_token_hint": "Stored locally. Grants access to this host.",
  "dashboard.remote_mode_openwork": "OpenWork host",
  "dashboard.remote_mode_direct": "OpenCode direct",
  ...
  "onboarding.remote_workspace_title": "Connect to an OpenWork host",
  "onboarding.remote_workspace_description": "Use the host URL and token from your OpenWork setup.",
  "onboarding.remote_workspace_action": "Connect",
  "onboarding.remote_workspace_card_title": "Connect to a host",
  "onboarding.remote_workspace_card_description": "Pair with an OpenWork host or connect directly to an OpenCode engine.",
