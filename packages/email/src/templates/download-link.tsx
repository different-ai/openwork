...
export function DownloadLinkEmail({ organizationName, downloadUrl }: DownloadLinkEmailProps) {
  const intro = organizationName
    ? `Here's your link to download the Micx desktop app for ${organizationName}.`
    : "Here's your link to download the Micx desktop app."

  return (
    <Html>
      <Head />
      <Preview>Your Micx download link</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>Micx desktop</Text>
          <Heading style={styles.heading}>Download Micx</Heading>
          ...
          <Button href={downloadUrl} style={styles.button}>Download Micx</Button>
