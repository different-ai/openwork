...
Add self-serve SCIM to `ee/apps/den-api` so an organization in Micx Cloud can:
...
For Micx Cloud, the safer stance is:
...
1. Are Micx identities allowed to be globally shared across orgs when SCIM emails match?
