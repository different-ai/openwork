...
**Core principle:** Forge artifacts define scope; Forge skills enforce execution discipline.
...
**Non-negotiables:**
- No behavior-changing code without `forge/tracks/<change>/tasks.md`
- No implementation without a failing test first
- No archive without verification evidence
- If implementation diverges, update `intent.md`, `design.md`, or delta contracts first

**Rationalizations to reject:**

| Excuse | Reality |
|--------|---------|
| "Skip artifacts, no time." | Use minimal artifacts. Speed comes from clarity. |
| "Manual verify is enough." | Evidence requires a test/build run. |
...
**Red Flags - STOP**
- "It's a tiny change, skip artifacts."
- "Tests later."
- "Archive now, verify later."
