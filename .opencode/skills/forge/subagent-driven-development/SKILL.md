...
digraph process {
    ...
    "Read tasks file, extract all tasks with full text, note context, create TodoWrite" -> "Dispatch implementer subagent (./implementer-prompt.md)";
...
[Read tasks file once: forge/tracks/<change>/tasks.md]
...
- Make subagent read tasks file (provide full text instead)
...
**Forge note:** Use `forge/tracks/<change>/tasks.md` for progress and pause if tasks are ambiguous or missing artifacts.
