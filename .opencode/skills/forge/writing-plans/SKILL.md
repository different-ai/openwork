...
**Context:** This should be run in a dedicated worktree (created by brainstorming skill) and after forge-preflight.

**Save plans to:** `forge/tracks/<change>/tasks.md`
...
## Remember
- Write directly to `forge/tracks/<change>/tasks.md`
