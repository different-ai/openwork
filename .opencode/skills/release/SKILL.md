...
## Bump
Update versions in `packages/app/package.json`, `packages/desktop/package.json`, and `packages/orchestrator/package.json` (publishes as `openwork-orchestrator`). Use one of these commands.
