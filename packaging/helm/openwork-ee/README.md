...
For a single Linux host or LXC without Kubernetes, see [the native tarball guide](https://github.com/different-ai/openwork/blob/dev/packages/docs/start-here/linux-native-tarball.mdx).
