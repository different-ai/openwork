...
/*
 * Rule table derived from the gitleaks project (MIT), config/gitleaks.toml, pinned at
 ...
 *
 * Upstream copyright and permission notice: LICENSES/MIT.txt.
 * File-level attribution is declared in REUSE.toml.
 */
