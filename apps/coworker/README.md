...
First run: sign in with your OpenWork account (open sign-in → copy link →
paste), create a coworker, pick its model, give it work. Its identity and
memory are plain files under `~/.config/openwork/coworkers/`.
