...
export function resolveWorkerModel(coworker, purpose, providers, snapshot = null, defaults = {}, modelDefaults = DEFAULT_MODEL_DEFAULTS) {
  ...
  if (separator <= 0 || separator === id.length - 1) throw new Error("Choose a model in Customize › AI model before starting a Worker. No default or paid fallback was selected.");
