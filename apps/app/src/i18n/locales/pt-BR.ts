...
export default {
  ...
  "den.status_loaded_orgs": "{count} organização{plural} carregada(s).",
  "den.status_loaded_templates": "{count} template{plural} carregado(s) para {name}.",
  "den.status_loaded_workers": "{count} worker{plural} carregado(s) para {name}.",
  ...
  "status.limited_mcp_hint": "{count} MCP conectado(s) · reconecte para recursos completos",
  "status.limited_mode": "Modo Limitado",
  "status.mcp_connected": "{count} MCP conectado(s)",
  "status.openwork_ready": "OpenWork Pronto",
  "status.providers_connected": "{count} provedor{plural} conectado(s)",
