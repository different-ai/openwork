...
export default {
  ...
  "extensions.builtins_advanced_notice": "Built-in OpenWork extensions are disabled by your organization. Review them in Advanced.",
  ...
  "mcp.advanced_settings": "Advanced",
  "mcp.advanced_settings_hint": "Manage workspace MCPs, built-in tools, hidden items, and local configuration.",
