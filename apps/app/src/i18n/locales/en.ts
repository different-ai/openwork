...
export default {
  ...
  "providers.workspace_required": "Create a workspace before connecting an AI provider.",
  ...
  "settings.providers_workspace_required_title": "Create a workspace to use AI providers",
  "settings.providers_workspace_required_action": "Create workspace",
