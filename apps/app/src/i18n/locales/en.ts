...
export default {
  ...
  "join_org.error_invite_not_found": "This invite could not be found. Ask your admin for a fresh invite link.",
  "join_org.error_invite_unusable": "This invite has expired or was canceled. Ask your admin for a new one.",
  "join_org.error_network": "OpenWork could not reach that organization server. Check your connection or VPN, then try again.",
  "join_org.input_hint": "Accepted: invite links, install links, “server token”, openwork://den-auth links, or a raw sign-in code.",
  "join_org.input_label": "Invite or install link",
  "join_org.input_placeholder": "https://your-company.example/install?token=…",
  "join_org.invite_browser_wait": "Finish joining {clientName} in your browser. OpenWork connects automatically once you're in.",
  ...
  "join_org.waiting_browser_button": "Waiting for your browser…",
  "plugins.add": "Add",
