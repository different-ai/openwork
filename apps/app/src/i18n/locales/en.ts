...
export default {
  ...
  "settings.update_install_on_quit": "Installs when you quit. Keep working until then.",
  "settings.update_restart_now": "Restart now",
  "settings.update_restart_now_title": "Restart to update?",
  "settings.update_restart_now_message": "OpenWork will close and reopen. Any running tasks will be interrupted. You can keep working and the update will install when you quit.",
