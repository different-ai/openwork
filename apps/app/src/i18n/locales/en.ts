...
export default {
  ...
  "notifications.updater_available_title": "Update Available: v{version}",
  "notifications.updater_available_body": "A new version of OpenWork is available. Click to view release notes.",
  "notifications.updater_view_button": "View Update",
