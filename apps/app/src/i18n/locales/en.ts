...
export default {
  ...
  "settings.tab_description_environment": "Store local service credentials for skills, MCPs, and sidecars — image and TTS APIs, GitHub, cloud services, proxies, and unsupported model providers. Values stay on your device.",
