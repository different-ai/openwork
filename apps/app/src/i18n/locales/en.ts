...
export default {
  ...
  "settings.workspace_engine_title": "Agent engine",
  "settings.workspace_engine_desc": "Choose which agent runs tasks in this workspace.",
  "settings.workspace_engine_opencode_title": "OpenCode",
  "settings.workspace_engine_opencode_desc": "The default and safest choice, with full approvals, durable sessions, and OAuth providers.",
  "settings.workspace_engine_recommended": "Recommended",
  "settings.workspace_engine_flue_title": "Flue",
  "settings.workspace_engine_flue_desc": "Try the new Flue engine.",
  "settings.workspace_engine_experimental": "Experimental",
  "settings.workspace_engine_flue_warning": "Flue does not yet support approvals, durable sessions, or OAuth providers. Flue and OpenCode keep chats separately, so your existing chats will disappear from view when you switch and return when you switch back.",
  "settings.workspace_engine_indicator_flue": "Flue · Experimental",
  "settings.workspace_engine_switch_success": "This workspace now uses {engine}.",
  "settings.workspace_engine_switch_error": "Couldn’t switch the agent engine. {message}",
