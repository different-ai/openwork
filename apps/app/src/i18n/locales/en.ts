...
export default {
  ...
  "connect.confirm_body": "Your team runs OpenWork on {host}. Nothing on this computer changes until you continue.",
  ...
  "connect.confirm_signin_note": "This link only points the app at your team's server. You'll sign in with your work account next.",
