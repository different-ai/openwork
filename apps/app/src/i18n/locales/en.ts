...
export default {
  ...
  "extensions.sign_up_action": "Sign up →",
  "extensions.sign_up_banner": "Sign up to share your skills and connectors with your team.",
  ...
  "settings.tab_ai_providers": "AI Providers",
  ...
  "settings.tab_description_ai_providers": "Connect services that provide AI models.",
  "settings.tab_description_appearance": "Adjust how OpenWork looks across desktop, system theme, and app frame.",
  "settings.tab_description_cloud": "OpenWork Cloud account and organization.",
  ...
  "settings.tab_description_ollama": "Connect to Ollama and manage local models",
  ...
  "ui.add_provider_to_run": "Add a provider to run tasks.",
  "ui.advanced_diagnostics": "Advanced diagnostics",
  "ui.agent_access_diagnostics": "Agent access diagnostics",
  "ui.agent_access_diagnostics_desc": "Technical details for OpenWork Cloud MCP delivery. Tokens and Authorization headers are redacted before display or copy.",
  "ui.agent_diag_needs_org": "Select an organization before running agent access diagnostics.",
  "ui.agent_diag_needs_server": "Connect to the workspace server before running agent access diagnostics.",
  "ui.agent_diag_needs_workspace": "Select a workspace before running agent access diagnostics.",
  "ui.agent_diag_unavailable": "Agent access diagnostics are unavailable for the current workspace.",
  "ui.automations": "Automations",
  "ui.boot_activating_workspace": "Activating your workspace",
  "ui.boot_error": "Something went wrong",
  "ui.boot_loading_workspaces": "Loading your workspaces",
  "ui.boot_preparing_workspace": "Preparing workspace",
  "ui.boot_ready": "Ready",
  "ui.boot_starting_server": "Starting the OpenWork server",
  "ui.chat_engine": "Chat engine",
  "ui.chat_engine_desc": "OpenCode v1 is the default engine. OpenCode v2 (preview) runs as a parallel sidecar with live provider updates and no engine reloads; sessions created on one engine stay in that engine's list.",
  "ui.clear_draft_to_restore": "Clear the current draft to restore the unsent message",
  "ui.cloud_auth_restore_failed": "OpenWork could not finish restoring connected service access.",
  "ui.cloud_auth_restore_timeout": "OpenWork timed out while restoring connected service access.",
  "ui.cloud_check_failed": "OpenWork could not check connected service tools before sending.",
  "ui.cloud_choose_available_model": "Choose a model available from this provider, or check Settings → Advanced → Agent access diagnostics.",
  "ui.cloud_choose_compatible_model": "Choose a compatible model or open Settings → Connect for diagnostics.",
  "ui.cloud_choose_tool_calling_model": "Choose a model with tool calling, or check Settings → Advanced → Agent access diagnostics.",
  "ui.cloud_diag_copied": "Copied sanitized Cloud diagnostic.",
  "ui.cloud_mcp_health": "OpenWork Cloud MCP health",
  "ui.cloud_mcp_health_desc": "Use this when support needs exact runtime state. The main Connect card stays user-facing.",
  "ui.cloud_model_missing_required_tools": "The selected model is missing search_capabilities or execute_capability.",
  "ui.cloud_model_no_tool_calling": "The selected model does not support tool calling.",
  "ui.cloud_model_not_found": "The selected model was not found for this provider.",
  "ui.cloud_prepare_timeout": "OpenWork timed out while preparing connected service tools.",
  "ui.cloud_retry_or_check_diagnostics": "Retry, or check Settings → Advanced → Agent access diagnostics if the problem continues.",
  "ui.cloud_retry_or_connect": "Retry or open Settings → Connect.",
  "ui.cloud_tool_calling_unconfirmed": "OpenWork could not confirm that the selected model supports tool calling.",
  "ui.cloud_tool_projection_unreadable": "OpenWork could not read tool capability information for the selected provider and model.",
  "ui.cloud_tools_context_mismatch": "Connected service tools were checked for a different provider or model.",
  "ui.cloud_tools_not_prepared": "Connected service tools could not be prepared.",
  "ui.cloud_tools_unproven": "OpenWork Cloud did not prove that search_capabilities and execute_capability are available.",
  "ui.cloud_unsupported_capability_result": "OpenWork received an unsupported tool capability result for the selected provider and model.",
  "ui.config_source_snapshot": "Config source snapshot",
  "ui.config_source_snapshot_desc": "Shows the OpenWork runtime database, the injected runtime config, and the workspace-owned OpenCode config files.",
  "ui.connect_model_provider": "Connect a model provider",
  "ui.connect_model_provider_desc": "Add an API key for Anthropic, OpenAI, Google, or other providers so tasks can run.",
  "ui.connect_own_provider_hint": "To keep working now, connect your own model provider.",
  "ui.copy_sanitized_diagnostic": "Copy sanitized diagnostic",
  "ui.could_not_change_destination": "Could not change destination.",
  "ui.could_not_send": "Couldn’t send your message",
  "ui.create_workspace_failed": "Failed to create workspace.",
  "ui.dashboard": "Dashboard",
  "ui.desired_runtime_config": "Desired OpenWork runtime config",
  "ui.desired_runtime_config_desc": "This is the OpenWork-built config object requested for the runtime database and injected safely by the server. Sensitive headers are redacted here.",
  "ui.developer": "Developer",
  "ui.direct_probe_steps": "Direct probe steps",
  "ui.draft_still_here": "Your draft is still here. Try sending it again.",
  "ui.engine_detail_config_sources": "OpenWork server config sources below can still be inspected.",
  "ui.engine_detail_ready": "Chat and task creation can use the OpenCode engine for this workspace.",
  "ui.engine_detail_restarting": "Chat and task creation may fail until OpenCode restarts.",
  "ui.experimental_engine": "Experimental engine",
  "ui.free_model_busy": "The free starter model is busy right now",
  "ui.free_starter_model": "Using the free starter model.",
  "ui.get_frontier_models": "Get frontier models with no API keys",
  "ui.hero_need_done": "What do you need done?",
  "ui.hero_suggest_csv_desc": "Drop in a CSV and describe the result you want.",
  "ui.hero_suggest_csv_prompt": "Create a sample CSV file with 20 rows of fake customer data (name, email, company, revenue). Then show me a summary of the data.",
  "ui.hero_suggest_csv_title": "Clean up a spreadsheet",
  "ui.hero_suggest_doc_desc": "Reports, emails, or briefs from a few bullet points.",
  "ui.hero_suggest_doc_prompt": "Draft a one-page project brief. Ask me for the bullet points you need, then turn them into a clear, well-structured document.",
  "ui.hero_suggest_doc_title": "Draft a document",
  "ui.hero_suggest_web_desc": "Use the built-in browser for repetitive steps.",
  "ui.hero_suggest_web_prompt": "Open craigslist.org in the browser and search for couches for sale. Show me the top 5 results with prices.",
  "ui.hero_suggest_web_title": "Automate a web task",
  "ui.hero_suggest_week_desc": "Pull highlights from email and calendar.",
  "ui.hero_suggest_week_prompt": "Summarize my week: pull the highlights from my connected email and calendar and give me a short digest of what happened and what needs my attention.",
  "ui.hero_suggest_week_title": "Summarize my week",
  "ui.hide_models_hint": "Hide OpenWork Models hint",
  "ui.last_engine_refresh": "Last engine refresh",
  "ui.no_ai_model_connected": "No AI model connected.",
  "ui.no_cloud_mcp_health": "No Cloud MCP health has been loaded for this workspace yet.",
  "ui.opencode_config_sources": "OpenCode config sources",
  "ui.opencode_config_sources_desc": "Inspect what OpenWork controls at runtime versus what belongs to your workspace config. This works through the OpenWork server and does not require the OpenCode engine to be healthy.",
  "ui.opencode_source_breakdown": "OpenCode source breakdown",
  "ui.opencode_source_breakdown_desc": "OpenCode also reads its own project and global config files. OpenWork injects the runtime config separately; for OpenWork-managed keys, the injected config is the source to inspect.",
  "ui.org_prompt": "Organization prompt",
  "ui.org_prompt_1": "Organization prompt 1",
  "ui.org_prompt_2": "Organization prompt 2",
  "ui.org_prompt_3": "Organization prompt 3",
  "ui.palette_accessible_items": "Accessible items",
  "ui.palette_accessible_none": "No servers or artifacts detected in this session yet",
  "ui.palette_accessible_open": "Open {count} servers and artifacts detected in this session",
  "ui.palette_choose_any_session": "Choose any session, including one from another workspace",
  "ui.palette_meta_artifact": "Artifact",
  "ui.palette_meta_current": "Current",
  "ui.palette_meta_hide": "Hide",
  "ui.palette_meta_server": "Server",
  "ui.palette_meta_session": "Session",
  "ui.palette_meta_workbench": "Workbench",
  "ui.palette_models_detail": "Choose the LLM that runs your next prompts",
  "ui.palette_move_session_to_group": "Add {title} to an existing group",
  "ui.palette_move_to_group_detail": "Add the selected task to an existing group",
  "ui.palette_new_split_detail": "Start an empty session beside this one",
  "ui.palette_new_workspace": "New workspace…",
  "ui.palette_no_accessible": "No accessible items found for this session.",
  "ui.palette_no_groups": "No groups found for this workspace.",
  "ui.palette_no_matches_root": "No matches. Try a different word, or type > for actions only.",
  "ui.palette_no_thinking_effort": "No thinking or effort options match your search.",
  "ui.palette_other_workspace": "Other workspace",
  "ui.palette_search_actions": "Search actions and settings…",
  "ui.palette_search_groups": "Search groups...",
  "ui.palette_search_servers_artifacts": "Search servers and artifacts...",
  "ui.palette_search_sessions_workspaces": "Search sessions and workspaces...",
  "ui.palette_search_thinking_effort": "Search thinking or effort...",
  "ui.palette_stop_tracking": "Stop tracking {name}",
  "ui.palette_thinking_effort": "Thinking / Effort",
  "ui.pick_another_version": "Pick another version",
  "ui.recovery_failed": "Recovery could not be started. Please retry.",
  "ui.recovery_preparing": "Preparing verified recovery…",
  "ui.recovery_ready": "Recovery is ready.",
  "ui.refresh_engine_connection": "Refresh engine connection",
  "ui.refreshing_engine": "Refreshing engine…",
  "ui.reload": "Reload",
  "ui.remove_workspace_files_first": "Remove workspace files before changing workspace.",
  "ui.restore_previous_version": "Restore previous version",
  "ui.restore_unsent_before_send": "Restore the unsent message before sending",
  "ui.restoring_session": "Restoring your session",
  "ui.retry_sending": "Retry sending",
  "ui.retrying": "Retrying…",
  "ui.runtime_config_status_failed": "Failed to load runtime config status.",
  "ui.search_empty_no_sessions": "No sessions yet.",
  "ui.search_keep_typing": "Keep typing to search message content…",
  "ui.search_messages": "Messages",
  "ui.search_no_matches": "No sessions or messages match your search.",
  "ui.search_placeholder": "Search all sessions and messages…",
  "ui.search_recent_sessions": "Recent sessions",
  "ui.search_result_count": "{count} results",
  "ui.search_role_agent": "Agent",
  "ui.search_role_user": "You",
  "ui.search_searching": "Searching messages…",
  "ui.search_session_titles": "Session titles",
  "ui.search_title": "Search sessions",
  "ui.server_detail_connected": "Runtime DB, workspace config, and migration diagnostics are available.",
  "ui.server_detail_needs_connection": "Runtime config diagnostics need the OpenWork server connection.",
  "ui.show_desired_json": "Show desired JSON",
  "ui.show_raw_json": "Show raw JSON",
  "ui.show_sanitized_health_json": "Show sanitized health JSON",
  "ui.show_workspace_run_mode": "Show workspace run mode",
  "ui.show_workspace_run_mode_desc": "Choose when OpenWork asks before acting, using the icon beside attachments. Off by default. Available with the standard desktop engine.",
  "ui.source_found": "Found",
  "ui.source_global_opencode": "Global opencode config",
  "ui.source_global_opencode_desc": "User-level OpenCode config under ~/.config/opencode.",
  "ui.source_injected": "OpenWork injected config",
  "ui.source_injected_desc": "The object OpenWork injects into OpenCode at runtime.",
  "ui.source_keys": "Keys: {keys}",
  "ui.source_not_found": "Not found",
  "ui.source_project_opencode": "Project opencode config",
  "ui.source_project_opencode_desc": "Workspace-level OpenCode config owned by the user/project.",
  "ui.source_runtime_db": "OpenWork runtime DB",
  "ui.source_runtime_db_desc": "OpenWork-managed runtime values stored outside workspace files.",
  "ui.start_failed_reload_hint": "Reload to try again, or return to a version that works on this computer.",
  "ui.start_failed_title": "OpenWork couldn't start",
  "ui.suggest_browse_web": "Browse the web",
  "ui.suggest_browse_web_desc": "Search Craigslist for couches",
  "ui.suggest_connect_extension": "Connect an extension",
  "ui.suggest_connect_extension_desc": "Add MCPs and integrations",
  "ui.suggest_connect_provider": "Connect a model provider",
  "ui.suggest_connect_provider_cta": "Connect a model provider to get started:",
  "ui.suggest_connect_provider_desc": "Add an API key for Anthropic, OpenAI, Google, or others",
  "ui.suggest_csv_prompt": "Create a sample CSV file with 20 rows of fake customer data (name, email, company, revenue). Then show me a summary of the data.",
  "ui.suggest_edit_csv": "Edit a CSV",
  "ui.suggest_edit_csv_desc": "Create a sample spreadsheet",
  "ui.suggest_org_prompts_cta": "Try one of your organization's prompts:",
  "ui.suggest_try_these": "Try one of these:",
  "ui.suggest_web_prompt": "Open craigslist.org in the browser and search for couches for sale. Show me the top 5 results with prices.",
  "ui.sync_with_cloud": "Sync with OpenWork Cloud",
  "ui.technical_details": "Technical details",
  "ui.toggle_sidebar": "Toggle Sidebar",
  "ui.unsent_saved_below": "Your unsent message is saved below.",
  "ui.use_version": "Use {version}",
  "ui.workspace_run_mode": "Workspace run mode",
  "ui.workspace_run_mode_desc": "Experimental approval controls in the composer.",
