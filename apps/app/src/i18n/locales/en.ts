 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Micx) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "Micx server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Micx server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "composer.connect_skill_prompt": "Use the \"{name}\" skill from the \"{marketplace}\" marketplace. Find it with micx-cloud_search_capabilities, then call micx-cloud_execute_capability with the exact capability name \"{capability}\", follow the returned skill content, and use it to ",
  ...
  "connect.connected_to_cloud": "Connected to Micx Cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed Micx agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved Micx agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "Micx agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective Micx agent resolution",
  "connect.diagnostics_check_cloud_endpoint_differential": "Runtime probe vs engine verdict",
  "connect.diagnostics_check_cloud_endpoint_transport": "Micx Cloud endpoint transport",
  "connect.diagnostics_check_cloud_tool_catalog": "Micx Cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global Micx Cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and Micx-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single Micx Cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_micx_client": "Micx client",
  "connect.diagnostics_owner_micx_server": "Micx server",
  "connect.diagnostics_owner_micx_support": "Micx support",
  ...
  "connect.diagnostics_configured_agent": "Configured Micx agent",
  "connect.diagnostics_effective_agent": "Effective Micx agent",
  "connect.diagnostics_agent_state": "Micx agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote Micx workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace Micx Cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from Micx Den.",
  ...
  "connect.pitch_title": "Connect is the new way Micx lets you share workflows with your team.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Micx servers.",
  ...
  "config.server_needed_hint": "Micx server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an Micx server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Micx server",
  ...
  "config.server_sharing_title": "Micx server sharing",
  "config.server_url_hint": "Use the URL shared by your Micx server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Micx server URL",
  "config.server_url_label": "Micx Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Micx server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Micx server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Micx server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Micx server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Micx server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Micx worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Micx worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an Micx server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Micx server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Micx worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update Micx and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Micx will reconnect here automatically.",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access Micx Cloud.",
  "den.cloud_section_title": "Micx Cloud",
  "den.cloud_sleep_hint": "Sign in to Micx Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use Micx Cloud.",
  "den.open_dashboard": "Open Den dashboard",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "Micx Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but Micx Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid Micx sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete Micx Cloud sign-in.",
  "den.error_signout_failed": "Could not sign out of Micx Cloud. Try again.",
  ...
  "den.signin_code_note": "Accepts an micx://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into Micx automatically, paste the sign-in link or one-time code from Micx Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "micx://den-auth?... or pasted code",
  "den.signin_title": "Sign in to Micx Cloud",
  "den.signing_in": "Finishing Micx Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect Micx.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Micx.",
  "den.status_cloud_signed_in_as": "Connected Micx Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected Micx Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your Micx Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. Micx is using the default Cloud control plane.",
  ...
  "extensions.empty_connections": "{org} has not shared any connections with you yet. An admin adds them in the Micx Cloud dashboard.",
  "extensions.empty_connections_signed_out": "Connections are shared by your organization. Sign in to Micx Cloud from Account to see yours.",
  ...
  "extensions.marketplace_description": "Browse Micx built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through Micx Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "extensions.surface_cloud": "Micx Cloud",
  ...
  "mcp.toggle_requires_server": "Connect to an Micx server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Micx can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Micx needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Micx needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Micx",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Micx.",
  ...
  "mcp.quick_connect_micx_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_micx_cloud_title": "Micx Cloud Control",
  "mcp.quick_connect_micx_ui_desc": "Let agents see and drive the Micx app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_micx_ui_title": "Micx UI Control",
  ...
  "notifications.empty_hint": "Updates from Micx Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the Micx server",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. Micx will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// Micx server URL.",
  "welcome.organization_server_link": "Using Micx on-premises?",
  "welcome.organization_server_url_label": "Organization server URL",
  "welcome.organization_server_url_placeholder": "https://micx.yourcompany.com",
  "welcome.team_signin": "Joining a team? Sign in",
  "welcome.use_cloud": "Use Micx Cloud",
  "welcome.use_cloud_subtitle": "Sign in for hosted Micx and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Micx will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Micx can pick them up.",
  ...
  "join_org.error_invalid": "That does not look like an Micx organization invite or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid Micx organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "Micx could not reach that organization server. Check your connection or VPN, then try again.",
  "join_org.input_hint": "Accepted: install links, “server token”, micx://den-auth links, or a raw sign-in code.",
  "join_org.input_label": "Invite or install link",
  "join_org.input_placeholder": "https://your-company.example/install?token=…",
  "join_org.micx_cloud": "Micx Cloud",
  ...
  "session.share_local_host_not_ready": "Local Micx host is not ready yet.",
  "session.share_missing_host_url": "Missing Micx host URL.",
  "session.share_missing_token": "Missing Micx token.",
  ...
  "session.share_micx_workers_only": "Share service links are available for Micx workers.",
  ...
  "settings.privacy_section_desc": "Control what Micx shares to improve the product.",
  ...
  "settings.capabilities_title": "Micx server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point Micx at a local OpenCode build",
  ...
  "settings.debug_micx_server_version": "Micx server: {version}",
  ...
  "settings.deeplink_hint": "Accepts micx:// or micx-dev:// links.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which Micx events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Micx. Off by default.",
  ...
  "settings.feedback_title": "Help shape Micx",
  ...
  "settings.nuke_confirmation_hint": "Micx will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local Micx, OpenCode, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed Micx app and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's Micx state (.opencode/micx) is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste an Micx deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard Micx Cloud.",
  "settings.organization_server_desc": "Point Micx at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's Micx server URL. Saving signs you out so Micx can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Micx.",
  ...
  "settings.micx_config_sidecar_desc": "Local Micx server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.micx_diagnostics_title": "Micx server diagnostics",
  "settings.micx_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.micx_server_label": "Micx server",
  ...
  "settings.quit_hint": "Micx quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Micx server.",
  "settings.reconnected": "Reconnected to Micx server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Micx cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Micx cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Micx will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Micx preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Micx local preferences and workspace onboarding markers.",
  "settings.reset_micx_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside micx-dev-data.",
  "settings.reset_micx_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside micx-dev-data.",
  "settings.reset_micx_title": "Reset Micx + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but Micx will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_micx_server": "Restart Micx server",
  ...
  "settings.services_section_desc": "Local services that power this Micx session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Micx.",
  ...
  "settings.runtime_desc": "Status for your local engine and Micx server.",
  ...
  "settings.tab_connect": "Micx Connect",
  ...
  "settings.tab_description_appearance": "Adjust how Micx looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Micx workspace plus its runtime connection.",
  ...
  "settings.environment.footer_hint": "MICX_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure OpenCode runtime settings from your shell.",
  "settings.environment.override_hint": "Environment variables set before Micx starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "Micx will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Micx is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but Micx status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "MICX_ and OPENCODE_ names are managed by Micx/OpenCode.",
  ...
  "memory.sign_in_hint": "Sign in to your Micx account to view your memory bank.",
  ...
  "settings.update_blocked_org": "Micx {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts Micx and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts Micx now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep Micx up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an Micx host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Micx server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active Micx Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active Micx Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "Micx Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full Micx features",
  ...
  "system.reload_body_default": "Micx detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Micx detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Micx can't load tasks from this worker until the connection is fixed.",
