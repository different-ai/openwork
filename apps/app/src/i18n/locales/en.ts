...
export default {
  ...
  "models.title": "Models",
  "models.repick_title": "Choose a replacement model",
  "models.repick_description": "{model} is no longer available. Choose a model and confirm where to use it.",
  "models.repick_choose": "Choose a model",
  "models.repick_suggested": "Suggested from the same provider, otherwise your workspace default. Nothing changes until you confirm.",
  "models.repick_scope": "Apply to",
  "models.repick_this": "This session only",
  "models.repick_all": "All {count} unarchived sessions using {model} in this workspace",
  "models.repick_local": "Saved on this device for the next send. No messages are sent and your default model stays unchanged. You can choose another model later.",
  "models.repick_confirm": "Confirm for {count} session(s)",
  "models.repick_saved": "Saved locally for the next send. The engine binding has not been updated. To change this choice, pick another model.",
  "models.repick_failed": "Could not save this selection. Check the refreshed models and session preview, then confirm again.",
