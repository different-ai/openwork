...
export default {
  ...
  "connect.ready_title": "Ready to connect",
  "connect.ready_body": "This enterprise install will not connect to OpenWork Cloud automatically. Use your organization's signed link, then review and confirm its server and branding.",
  "connect.paste_label": "Have the link? Paste it here",
  "connect.paste_cta": "Connect",
  "connect.paste_invalid": "That doesn't look like an OpenWork connect link. It starts with openwork://connect?token=",
  "connect.advanced_toggle": "No link? Enter your organization's server manually",
  "connect.advanced_hint": "Ask your admin for the organization server address.",
  "connect.advanced_save": "Save",
  "connect.advanced_saving": "Saving…",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update OpenWork Enterprise and try again.",
