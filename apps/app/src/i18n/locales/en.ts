...
export default {
  ...
  "composer.discovery_skills_hint": "Find a skill for what you want to do. Add it to your draft, then describe the work. Nothing runs until you send.",
  "composer.discovery_connections_hint": "Ask for what you need in chat. OpenWork can use your ready connections when relevant. Connect your account here when a sign-in is needed.",
  "composer.discovery_skills_search": "Find a skill by name or what it does",
  "composer.discovery_connections_search": "Find a connection",
  "composer.discovery_no_matches": "No matches in this workspace. Try a different word or clear your search.",
  "composer.discovery_clear": "Clear search",
  "composer.discovery_use_skill": "Use in task",
