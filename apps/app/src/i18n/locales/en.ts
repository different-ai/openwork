...
export default {
  ...
  "settings.starter_bootstrap_desc": "Control whether OpenWork adds starter-only bootstrap content to new local starter workspaces.",
  "settings.starter_bootstrap_title": "Starter bootstrap",
  "settings.starter_bootstrap_toggle": "Automatic starter content",
  "settings.starter_bootstrap_toggle_desc": "When enabled, OpenWork seeds starter-specific commands, config entries, and default blueprint content for new starter workspaces.",
