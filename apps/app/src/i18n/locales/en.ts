...
export default {
  ...
  "skills.move_cloud_action": "Move to Cloud",
  "skills.move_cloud_description": "Save this skill privately in your active OpenWork Cloud organization, then remove its local filesystem copy.",
  "skills.move_cloud_success": "Moved {name} to OpenWork Cloud.",
  "skills.move_cloud_title": "Move skill to Cloud?",
  "skills.move_cloud_warning": "OpenWork will save {name} to Cloud first. Only after Cloud confirms the save will the local skill be removed. An existing Cloud skill with the same name will be updated.",
