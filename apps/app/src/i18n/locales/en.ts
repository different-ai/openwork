...
export default {
  ...
  "settings.run_mode.title": "Execution and approvals",
  "settings.run_mode.section_desc": "Choose how much agents may do before asking you. One choice applies to every workspace on this device, including scheduled Automations that run here.",
  "settings.run_mode.mode": "Run mode",
  "settings.run_mode.approve": "Approve each step",
  "settings.run_mode.approve_desc": "Agents follow your existing permission rules. By default they ask before working outside authorized folders, before reading .env files, before repeating an identical call, and wherever your opencode.json says to ask.",
  "settings.run_mode.run_everything": "Run everything",
  "settings.run_mode.run_everything_desc": "Prompts configured in your global opencode.json are skipped. Working outside authorized folders, reading .env files, and repeating an identical call still ask. Rules in a workspace's own opencode.json are unchanged.",
  "settings.run_mode.run_everything_warning": "You accept the risk of unattended tool runs in every workspace and Automation on this device. Deny rules in your global opencode.json can be overridden by this mode.",
  "settings.run_mode.updated": "Run mode updated.",
  "settings.run_mode.saving": "Saving run mode...",
