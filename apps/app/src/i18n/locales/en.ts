...
export default {
  ...
  "models.repick_targets_changed": "Matching sessions changed from {before} to {after}. Review the refreshed list, then confirm again.",
  "models.repick_targets_refresh_failed": "Matching sessions changed, but the refreshed list could not be loaded. Close and try again.",
  ...
  "settings.unavailable_model_repick_title": "Scoped model replacement",
  "settings.unavailable_model_repick_description": "Experimental replacement controls for unavailable session models.",
  "settings.unavailable_model_repick_toggle": "Show scoped replacement dialog",
  "settings.unavailable_model_repick_toggle_description": "Preview and replace the unavailable model for this session or matching idle sessions. Off by default.",
