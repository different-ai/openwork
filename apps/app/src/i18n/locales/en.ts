...
export default {
  ...
  "dashboard.create_workspace_subtitle": "Choose one folder for this workspace. OpenWork can read and create files there.",
  "dashboard.create_workspace_confirm": "Create Workspace",
  "dashboard.create_sandbox_confirm": "Create as sandbox",
  "dashboard.workspace_explainer_title": "How workspaces work",
  "dashboard.workspace_explainer_folder": "The folder you pick becomes this workspace's home for files, runs, and saved context.",
  "dashboard.workspace_explainer_access": "OpenWork only gets access to that folder, plus any extra folders you explicitly authorize later.",
  "dashboard.workspace_explainer_config": "OpenCode stores workspace-specific config in `.opencode/` inside that folder so each workspace stays self-contained.",
  ...
  "dashboard.choose_folder_next": "OpenWork will use this folder as the workspace home.",
