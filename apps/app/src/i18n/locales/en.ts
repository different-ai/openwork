...
export default {
  ...
  "composer.local_voice_empty": "No speech was detected.",
  "composer.local_voice_failed": "Local voice input failed.",
  "composer.local_voice_permission_denied": "Microphone access was denied. Enable it for OpenWork in System Settings.",
  "composer.local_voice_preparing": "Preparing local voice input",
  "composer.local_voice_setup_required": "Local voice input needs setup.",
  "composer.local_voice_start": "Start local voice input",
  "composer.local_voice_stop": "Stop recording",
  "composer.local_voice_transcribing": "Transcribing locally",
