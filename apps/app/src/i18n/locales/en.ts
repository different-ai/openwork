...
export default {
  ...
  "settings.update_ready_notice": "Update ready",
  "settings.update_ready_title": "Ready when you are.",
  "settings.update_close_details": "Close update details",
  "settings.update_install_on_quit": "The latest improvements are downloaded. Restart now, or they’ll install next time you quit.",
  "settings.update_downloaded_notice": "Downloaded and ready to install",
  "settings.update_later": "Later",
  "settings.update_restart_app": "Restart {appName}",
