...
export default {
  ...
  "settings.clicky_experiment_desc":
    "Show the hidden Clicky companion. It uses the current OpenWork surface to open a separate guided session.",
  "settings.clicky_experiment_disabled": "Clicky stays hidden until you opt in on this device.",
  "settings.clicky_experiment_enabled": "Clicky is enabled on this device.",
  "settings.clicky_experiment_forced": "Forced on by VITE_OPENWORK_EXPERIMENT_CLICKY=1.",
  "settings.clicky_experiment_title": "Clicky experiment",
  ...
  "settings.disable_clicky_experiment": "Disable Clicky",
  ...
  "settings.enable_clicky_experiment": "Enable Clicky",
