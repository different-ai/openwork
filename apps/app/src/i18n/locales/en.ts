...
export default {
  ...
  "context_panel.workspace_rules": "Permission rules in this workspace",
  "context_panel.workspace_rules_desc": "The permission block of this workspace's opencode.json. Rules saved from a prompt with \"Always allow in this workspace\" appear here and can be removed.",
  "context_panel.workspace_rules_empty": "This workspace's opencode.json has no permission rules.",
  "context_panel.workspace_rules_unavailable": "Connect to an OpenWork server workspace to see this workspace's permission rules.",
  "context_panel.workspace_rules_removed": "Rule removed from opencode.json.",
  "context_panel.workspace_rules_remove": "Remove rule {permission} {pattern}",
  "context_panel.workspace_rules_path": "File: {path}",
  ...
  "session.allow_in_workspace": "Always allow in this workspace",
  "session.allow_in_workspace_hint": "Also writes this allow rule into the workspace's opencode.json, where you can see and remove it.",
  "session.allow_in_workspace_saved": "Saved to this workspace's opencode.json.",
  "session.allow_in_workspace_unavailable": "Connect to a writable OpenWork server workspace to save this rule.",
  "session.allow_in_workspace_no_pattern": "The engine suggested no pattern to save for this request.",
