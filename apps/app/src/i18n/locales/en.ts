...
export default {
  ...
  "session_management.export_session": "Export",
  "session_management.export_this_session_json": "This session (JSON, can be imported)",
  "session_management.export_this_session_markdown": "This session (Markdown, for reading)",
  "session_management.export_all_sessions": "All sessions in this workspace",
  "session_management.import_sessions": "Import sessions...",
  "session_management.imported_empty": "Nothing imported yet",
  "session_management.export_done": "Session exported. Secret-like values were removed.",
  "session_management.export_failed": "Couldn't export sessions",
  "session_management.import_done_one": "Imported {count} session",
  "session_management.import_done_other": "Imported {count} sessions",
  "session_management.import_failed": "Couldn't import sessions",
  "session_management.import_invalid_file": "That file is not an OpenWork session export",
  "session_management.imported_label": "Imported",
  "session_management.imported_unknown_source": "Unknown workspace",
  "session_management.imported_from": "Imported from {workspace}",
  "session_management.read_only_badge": "Imported from {workspace} · read-only",
  "session_management.read_only_notice": "This session was imported from {workspace} and is read-only.",
  "session_management.read_only_notice_generic": "This session was imported and is read-only.",
  "session_management.read_only_hint": "Start a new session to continue this work.",
  "session_management.read_only_placeholder": "This imported session is read-only",
} as const;
