...
export default {
  ...
  "settings.environment.description": "Values are stored locally and injected into OpenCode, the OpenWork server, and opencode-router at spawn time. Changes apply on the next app launch.",
  "settings.environment.edit_title": "Edit environment variable",
  "settings.environment.empty_body": "API keys (for example ANTHROPIC_API_KEY) added here reach the app without launching it from a terminal.",
  ...
  "settings.tab_description_environment": "Store API keys and other env vars so the app can read them without a terminal launch.",
