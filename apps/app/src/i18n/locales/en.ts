...
export default {
  "account.aria": "Account and status",
  "account.aria_signed_in": "{email} — account and status",
  ...
  "account.restoring_session": "Restoring your session",
  "account.sync_cloud": "Sync with OpenWork Cloud",
  ...
  "connect.status_attention_title": "One possible issue: {description}",
  "connect.status_checking": "Checking",
  "connect.status_checking_tools": "Checking connected service tools in the background.",
  "connect.status_needs_attention": "Needs attention",
  "connect.status_ready": "Ready",
  "connect.status_restoring_tools": "Restoring connected service tools ({attempt}/{maxAttempts}).",
  "connect.status_signed_in_desc": "Signed in to OpenWork Cloud. Connected service tools will be checked when a workspace is active.",
  "connect.status_tools_failed_desc": "OpenWork Connect could not verify connected service tools. Run diagnostics for details.",
  "connect.status_tools_ready_desc": "Connected service tools are available.",
  ...
  "welcome.attribution_ai": "An AI assistant",
  "welcome.attribution_ai_placeholder": "e.g. “best open source alternative to Claude Cowork”",
  "welcome.attribution_ai_prompt": "What did you ask the AI?",
  "welcome.attribution_desc": "One quick question — it helps us know where to show up.",
  "welcome.attribution_github": "GitHub or open source community",
  "welcome.attribution_github_desc": "Repos, stars, awesome lists...",
  "welcome.attribution_person": "A friend or colleague",
  "welcome.attribution_person_desc": "Someone recommended it directly.",
  "welcome.attribution_search": "Search",
  "welcome.attribution_skip": "Skip",
  "welcome.attribution_skip_part": "Skip this part",
  "welcome.attribution_social": "Social media",
  "welcome.attribution_title": "How did you hear about OpenWork?",
  ...
  "welcome.manual_folder_label": "Daytona folder path",
  "welcome.manual_folder_submit": "Use this folder",
  ...
  "welcome.provider_api_key": "Bring your own API key",
  "welcome.provider_api_key_desc": "Connect OpenAI, Anthropic, Google, or another provider, then run your first task.",
  "welcome.provider_desc": "Connect a model, then try a real task in chat so you can see OpenWork work.",
  "welcome.provider_openwork_models": "Use OpenWork Models",
  "welcome.provider_openwork_models_desc": "Pay through OpenWork Cloud and skip API key setup.",
  "welcome.provider_skip": "Skip and use the free model",
  "welcome.provider_title": "Power your first task",
  ...
  "models.add_your_keys": "Add your keys",
  "models.change": "Change model",
  "models.connect_more_providers": "Connect more providers",
  "models.count_one": "{count} model",
  "models.count_other": "{count} models",
  "models.current": "Current",
  "models.disable_provider": "Disable this provider",
  "models.done": "Done",
  "models.enable": "Enable",
  "models.enabled": "Enabled",
  "models.enable_provider": "Enable this provider",
  "models.hide_openwork_models": "Hide OpenWork Models",
  "models.hide": "Hide",
  "models.hosted_frontier_models": "Hosted frontier models",
  "models.hosted_no_api_keys": "Hosted · no API keys",
  "models.included_pending_reload": "Included on your plan — pending workspace reload.",
  ...
  "models.picker_default_subtitle": "Select a model for this session.",
  "models.picker_unavailable_subtitle": "The model you were using is no longer available. Select a different model for this session.",
  "models.promo_signin_desc": "Sign in to unlock hosted frontier models for your team.",
  "models.promo_subscribe_desc": "Subscribe to use hosted frontier models in this workspace.",
  ...
  "models.sign_in": "Sign in",
  "models.subscribe": "Subscribe",
  "models.subscription_unlocks": "One subscription unlocks these in every workspace.",
  "models.title": "Models",
  "models.your_api_keys": "Your API keys",
  ...
  "session.empty_description": "Describe it in plain language",
  "session.empty_title": "What do you need done?",
  "session.free_model_hint": "Using the free starter model.",
  "session.frontier_models_cta": "Get frontier models with no API keys",
  "session.hide_models_hint": "Hide OpenWork Models hint",
  "session.connect_model_provider": "Connect a model provider",
  "session.connect_model_provider_desc": "Add an API key for Anthropic, OpenAI, Google, or another provider so tasks can run.",
  "session.suggestion_week_title": "Summarize my week",
  "session.suggestion_week_desc": "Pull highlights from email and calendar.",
  "session.suggestion_week_prompt": "Summarize my week: pull the highlights from my connected email and calendar and give me a short digest of what happened and what needs my attention.",
  "session.suggestion_spreadsheet_title": "Clean up a spreadsheet",
  "session.suggestion_spreadsheet_desc": "Drop in a CSV and describe the result you want.",
  "session.suggestion_spreadsheet_prompt": "Create a sample CSV file with 20 rows of fake customer data (name, email, company, revenue). Then show me a summary of the data.",
  "session.suggestion_document_title": "Draft a document",
  "session.suggestion_document_desc": "Reports, emails, or briefs from a few bullet points.",
  "session.suggestion_document_prompt": "Draft a one-page project brief. Ask me for the bullet points you need, then turn them into a clear, well-structured document.",
  "session.suggestion_web_title": "Automate a web task",
  "session.suggestion_web_desc": "Use the built-in browser for repetitive steps.",
  "session.suggestion_web_prompt": "Open craigslist.org in the browser and search for couches for sale. Show me the top 5 results with prices.",
  ...
  "settings.openwork_models_connect": "Connect",
  "settings.openwork_models_connect_description": "Hosted frontier models without managing API keys.",
  "settings.openwork_models_description": "Hosted frontier models for OpenWork tasks without managing provider API keys.",
  "settings.openwork_models_dismiss": "Dismiss OpenWork Models banner",
  "settings.openwork_models_managed": "Managed by OpenWork Cloud",
  "settings.openwork_models_no_api_key": "No API key setup",
  "settings.openwork_models_not_connected": "Not connected",
  "settings.openwork_models_pricing": "Pricing is handled through OpenWork Cloud. You can continue using OpenCode Zen or your own providers.",
  "settings.openwork_models_subscribe": "Subscribe",
  "settings.openwork_models_syncing": "Included — syncing",
  "settings.openwork_models_syncing_desc": "OpenWork Models will become available automatically when the pending workspace reload completes.",
  ...
  "settings.tab_description_hub": "Overview of all settings",
