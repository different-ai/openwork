...
export default {
  ...
  "settings.environment.confirm_delete": "Delete {key}? This takes effect on the next app launch.",
  "settings.environment.delete": "Delete",
  "settings.environment.description": "Values are stored locally and injected into every process OpenWork launches — OpenCode, the OpenWork server, opencode-router, and any MCP they spawn. Changes apply on the next app launch.",
  "settings.environment.edit_title": "Edit environment variable",
  "settings.environment.empty_body": "Add keys like ANTHROPIC_API_KEY, GOOGLE_API_KEY, ELEVENLABS_API_KEY, or GITHUB_TOKEN — whatever the skills and MCPs in this workspace call into.",
  ...
  "settings.environment.key_hint": "Uppercase, digits, and underscores. Cannot start with a digit.",
  "settings.environment.key_label": "Key",
  "settings.environment.loading": "Loading…",
  "settings.environment.remote_workspace_hint": "Environment variables are managed on the host machine. Use cloud LLM Providers for remote workspaces.",
  "settings.environment.restart_required": "Saved. Quit and relaunch OpenWork for changes to take effect.",
  ...
  "settings.environment.validation_shape": "Use uppercase letters, digits, and underscores; do not start with a digit.",
  "settings.environment.value_label": "Value",
  "settings.tab_description_environment": "Add credentials for the services your skills and MCPs call into — LLM providers, image and TTS APIs, GitHub, cloud services. Values stay on your device.",
