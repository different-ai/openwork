...
export default {
  ...
  "models.title": "Models",
  "models.repick_title": "{model} is no longer available",
  "models.repick_choose": "Choose a replacement model",
  "models.repick_suggested": "Suggested replacement",
  "models.repick_scope": "Apply to",
  "models.repick_this": "This session only",
  ...
  "models.repick_failed": "Could not save this selection. Check the refreshed models, then try again.",
  "models.repick_single_failed": "Could not verify this session. Close and try again when it is idle.",
  "models.repick_bulk_failed": "Could not verify all matching sessions. Use This session only, or close and try again.",
  "models.repick_catalog_failed": "Could not load available models. Close and try again.",
  ...
  "session.error_action_open_den_models": "Open Den → Models",
  "session.error_action_reconnect": "Reconnect",
  "session.error_action_repick": "Re-pick model",
  "session.error_budget_exceeded_description": "The provider rejected this request because its budget is exhausted. Increase the provider budget or choose another model.",
  "session.error_budget_exceeded_title": "Provider budget exceeded",
  "session.error_den_disconnected_description": "OpenWork cannot verify this organization model while Cloud is disconnected. Reconnect, then try again.",
  "session.error_den_disconnected_title": "OpenWork Cloud is disconnected",
  "session.error_model_unavailable_description": "This model is no longer in the available model list. Choose a replacement before sending again.",
  "session.error_model_unavailable_title": "This model is no longer available",
  "session.error_organization_credential_missing_description": "An organization administrator needs to add or replace this model provider’s credential in OpenWork Cloud.",
  "session.error_organization_credential_missing_title": "This organization model needs a provider credential",
  "session.error_provider_auth_description": "Reconnect this model provider or replace its credential before sending again.",
  "session.error_provider_auth_title": "This model provider needs a valid credential",
