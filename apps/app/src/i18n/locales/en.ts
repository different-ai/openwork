...
export default {
  ...
  "connect.diagnostics_check_engine_plugin_tools": "OpenWork registry tools",
  ...
  "connect.diagnostics_plugin_tools_empty": "Only registry-declared OpenWork tool IDs are retained in this report; custom and non-OpenWork tool names are excluded.",
  "connect.diagnostics_plugin_tools_description": "The canonical OpenWork context registry is compared with the selected engine's bounded tool-ID catalog.",
  "connect.diagnostics_plugin_tools_title": "OpenWork tool registry",
  ...
  "settings.developer_mode_desc": "Enables debug tools, diagnostics, performance logs, and the Developer tab. Exact prepared-prompt tracing requires a separate opt-in below.",
