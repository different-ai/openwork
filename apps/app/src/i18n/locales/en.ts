...
export default {
  ...
  "settings.run_mode.section_desc": "Choose how much agents can do before asking you. One choice applies to every workspace on this device.",
  "settings.run_mode.mode": "Run mode",
  "settings.run_mode.approve": "Approve each step",
  "settings.run_mode.approve_desc": "Agents ask before running shell commands and other risky tools.",
  "settings.run_mode.run_everything": "Run everything",
  "settings.run_mode.run_everything_desc": "Agents run shell commands, file edits, and MCP tools without asking. Writes outside authorized folders and repeated identical calls still ask.",
  "settings.run_mode.run_everything_warning": "Only use this if you trust this device's workspaces and accept the risk of unattended tool runs.",
