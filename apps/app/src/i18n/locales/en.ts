...
export default {
  "ai.connect": "Connect",
  "ai.dismiss_banner_aria": "Dismiss OpenWork Models banner",
  "ai.hosted_models_banner": "Hosted frontier models for OpenWork tasks without managing provider API keys.",
  "ai.hosted_models_card": "Hosted frontier models without managing API keys.",
  "ai.managed_by_cloud": "Managed by OpenWork Cloud",
  "ai.no_api_key_setup": "No API key setup",
  "ai.not_connected": "Not connected",
  "ai.pricing_note": "Pricing is handled through OpenWork Cloud. You can continue using OpenCode Zen or your own providers.",
  "ai.subscribe": "Subscribe",
  "browser_extension.ready_by_default": "Ready by default",
  "browser_extension.desc": "The OpenWork Browser runs inside the app, opens visibly for browser tasks, and is the supported browser automation path in OpenWork.",
  "chat.now_label": "Now: ",
  "chat.tool_step_unavailable": "Tool step unavailable",
  "common.preview": "Preview",
  "composer.mcp_menu_empty_fallback": "No library items enabled. Open Library to enable them.",
  "den.search_org_aria": "Search organizations",
  "den.search_org_placeholder": "Search organizations...",
  "den.select_org_desc": "Choose the organization to use with this workspace. Sign out to switch later.",
  "den.select_org_title": "Select an organization",
  "extensions.blocked_builtins_notice": "Built-in OpenWork extensions are disabled by your organization. Use \u201cShow hidden\u201d to view blocked ones.",
  "extensions.discovered_global": "Found in the global plugins folder.",
  "extensions.discovered_workspace": "Found in the workspace plugins folder.",
  "extensions.empty_filter": "Try a different query or filter, or add an MCP server.",
  "extensions.empty_filter_mcp": "MCP-based connections will appear here. Try a different query or add an MCP server.",
  "extensions.no_library_items": "Nothing found",
  "extensions.no_plugins_configured": "No plugins configured yet.",
  "extensions.plugin_dir_read_only": "Plugins found in folders are read-only.",
  "extensions.plugin_failed_add": "Failed to add plugin.",
  "extensions.plugin_failed_load": "Failed to load plugins.",
  "extensions.plugin_failed_remove": "Failed to remove plugin.",
  "extensions.plugin_global_only": "Global plugins are only available to local workers.",
  "extensions.plugin_not_found": "Plugin not found.",
  "extensions.plugin_server_cannot_read": "The OpenWork server cannot read plugins for this workspace.",
  "extensions.plugin_server_cannot_write": "The OpenWork server cannot write plugins for this workspace.",
  "extensions.plugin_server_unavailable": "The OpenWork server is unavailable. Sign in to manage plugins.",
  "extensions.plugins_section": "OpenCode plugins",
  "extensions.shared_by_org": "Shared by your organization",
  "extensions.shared_connection": "Shared connection",
  "extensions.show_hidden": "Show hidden",
  "extensions.show_hidden_count": "Show hidden ({count})",
  "extensions.showing_hidden": "Showing hidden",
  "gate.running_app": "Running app",
  "gate.why_stopped": "Why OpenWork stopped here",
  "gate.your_system": "Your system",
  "marketplace.all_marketplaces": "All marketplaces",
  "marketplace.cloud_control_notice": "OpenWork stores this sign-in in your organization's cloud. Once connected, your desktop agent will be able to use tools through OpenWork Cloud Control.",
  ...
  "marketplace.no_details": "This extension does not provide detailed content yet.",
  "marketplace.no_match": "No marketplace extension matches your search or filters.",
  "marketplace.search_placeholder": "Search marketplace extensions...",
  "marketplace.signin_notice": "You can use OpenWork without an account. Sign in to OpenWork Cloud to load the Marketplace — including built-in OpenWork extensions and your organization's marketplaces.",
  "mcp.from_github": "From GitHub",
  "mcp.item_unavailable_workspace": "This library item is not available in the current workspace.",
  "mcp.no_servers_configured": "No MCP servers configured yet.",
  "mcp.org_account": "Organization account",
  "mcp.register_failed_status": "Some MCP servers failed to register with the engine: {names}. They may appear disabled — try restarting the engine.",
  "mcp.search_library_placeholder": "Search library...",
  "mcp.view_details": "View details",
  "mcp.your_account": "Your account",
  "model_picker.add_your_keys": "Add your keys",
  "model_picker.all_models": "All models",
  "model_picker.change_model": "Change model",
  "model_picker.connect_more_providers": "Connect more providers",
  "model_picker.current": "Current",
  "model_picker.disable_provider_aria": "Disable this provider",
  "model_picker.enable": "Enable",
  "model_picker.enable_provider_aria": "Enable this provider",
  "model_picker.enabled": "Enabled",
  "model_picker.hide": "Hide",
  "model_picker.hosted_no_api_keys": "hosted \u00b7 no API keys",
  "model_picker.included_syncing": "Included — syncing to this workspace\u2026",
  "model_picker.new": "New",
  "model_picker.no_models_found": "No models found.",
  "model_picker.search_placeholder": "Search models...",
  "model_picker.select_model_subtitle": "Select a model for this session.",
  "model_picker.sign_in": "Sign in",
  "model_picker.sign_in_to_unlock": "Sign in to unlock frontier models for your team.",
  "model_picker.subscribe": "Subscribe",
  "model_picker.subscribe_to_use": "Subscribe to use frontier models in this workspace.",
  "model_picker.unavailable_subtitle": "The previously used model is no longer available — choose another model for this session.",
  "model_picker.your_api_keys": "Your API keys",
  "search.footer_hint": "\u2191\u2193 to navigate \u00b7 \u21b5 to open",
  "search.keep_typing": "Keep typing to search message contents\u2026",
  "search.no_match": "No session or message matches your query.",
  "search.no_sessions_yet": "No sessions yet.",
  "search.placeholder": "Search all sessions and messages\u2026",
  "search.recent": "Recent sessions",
  ...
  "session.add_provider": "Add a provider to run tasks.",
  "session.close_esc": "Close (Esc)",
  "session.close_find_aria": "Close find",
  "session.find_in_conversation": "Find in conversation (\u2318F)",
  "session.find_in_conversation_short": "Find in conversation",
  "session.next_match": "Next match (\u21b5)",
  "session.next_match_aria": "Next match",
  ...
  "session.previous_match_aria": "Previous match",
  "session.thinking_label": "Thinking",
  "settings.add_folder": "Add folder",
  "settings.card_cloud_account": "Cloud",
  "settings.card_desc_advanced": "Runtime, engine, and developer options.",
  "settings.card_desc_ai": "Connect services that provide AI models.",
  "settings.card_desc_appearance": "Theme, font size, and display.",
  "settings.card_desc_cloud_account": "OpenWork Cloud account and organization.",
  "settings.card_desc_environment": "Environment variables and paths.",
  "settings.card_desc_permissions": "Authorized folders and file access.",
  "settings.card_desc_preferences": "Default model, reasoning, and context compaction.",
  "settings.card_desc_recovery": "Reset onboarding and clear data.",
  "settings.card_desc_updates": "App version and update channel.",
  "settings.channel_alpha": "Alpha",
  "settings.channel_stable": "Stable",
  "settings.current_version": "Current version",
  "settings.group_help": "Help",
  "settings.release_channel": "Update channel",
  "settings.release_channel_desc": "The stable channel receives fully tested releases. The alpha channel includes the latest changes but may be less polished (macOS only).",
  ...
  "settings.tab_description_preferences": "Default model, reasoning, and context compaction",
  "settings.tab_permissions": "Permissions",
  "settings.tab_preferences": "Preferences",
  "status.account_and_status_aria": "Account and status",
  "status.log_out": "Sign out",
  "status.openwork_models_subtitle": "frontier models in the cloud",
  "status.restoring_session": "Restoring your session",
  "status.run_diagnostics": "Run diagnostics",
  "status.sign_in": "Sign in",
  "status.sync_with_cloud": "Syncing with OpenWork Cloud",
  "suggestions.browse_web": "Browse the web",
  "suggestions.browse_web_desc": "Find couches on Craigslist",
  "suggestions.connect_extension": "Connect an extension",
  "suggestions.connect_extension_desc": "Add MCP servers and integrations",
  "suggestions.connect_provider": "Connect a model provider",
  "suggestions.connect_provider_cta": "Connect a model provider to get started:",
  "suggestions.connect_provider_desc": "Add an API key for Anthropic, OpenAI, Google, or other providers",
  "suggestions.default_cta": "Try something from this list:",
  "suggestions.edit_csv": "Edit a CSV",
  "suggestions.edit_csv_desc": "Create a sample spreadsheet",
  "suggestions.org_prompts_cta": "Try one of your organization's prompts:",
  ...
  "composer.empty_hero_title": "What do you need done?",
  "composer.empty_hero_subtitle": "Describe it in plain language",
  "composer.starter_model_hint": "Using the free starter model.",
  "composer.starter_model_link": "Get frontier models with no API keys",
  "composer.hide_models_hint_aria": "Hide OpenWork Models hint",
  ...
  "composer.suggestion_week_title": "Summarize my week",
  "composer.suggestion_week_desc": "Pull highlights from email and calendar.",
  "composer.suggestion_week_prompt": "Summarize my week: pull the highlights from my connected email and calendar and give me a short digest of what happened and what needs my attention.",
  ...
  "composer.suggestion_spreadsheet_prompt": "Create a sample CSV file with 20 rows of fake customer data (name, email, company, revenue). Then show me a summary of the data.",
  ...
  "composer.suggestion_document_prompt": "Draft a one-page project brief. Ask me for the bullet points you need, then turn them into a clear, well-structured document.",
  "composer.suggestion_web_task_title": "Automate a web task",
  "composer.suggestion_web_task_desc": "Use the built-in browser for repetitive steps.",
  "composer.suggestion_web_task_prompt": "Open craigslist.org in the browser and search for couches for sale. Show me the top 5 results with prices.",
  "computer_use.verify_permissions": "Verify permissions",
  "computer_use.unreadable_response": "Unreadable response.",
  "computer_use.title": "Computer Use setup (Mac only)",
  "computer_use.step_grant_permissions_desc": "Opens the OpenWork Computer Use helper. Grant both permissions there, then click Verify below.",
  "computer_use.step_grant_permissions": "2. Grant macOS permissions",
  "computer_use.step_connect_mcp_desc": "Adds the local Computer Use server to this workspace so Composer can use the computer-control tools.",
  "computer_use.step_connect_mcp": "1. Connect Computer Use MCP",
  "computer_use.screen_recording": "Screen Recording",
  "computer_use.reopen_helper": "Reopen helper",
  "computer_use.permissions_verified": "Permissions verified. Try a Composer prompt that uses Computer Use.",
  "computer_use.opening": "Opening…",
  "computer_use.needed": "Needed",
  "computer_use.mac_only_error": "Computer Use is Mac only and requires the OpenWork desktop app on macOS.",
  "computer_use.granted": "Granted",
  "computer_use.grant_permissions": "Grant permissions",
  "computer_use.desc": "Computer Use only works on Mac. Connect the local MCP server and grant the macOS permissions it needs to control apps.",
  "computer_use.connecting": "Connecting…",
  "computer_use.connect_mcp": "Connect MCP",
  "computer_use.configured": "Configured",
  "computer_use.after_grant_click_verify": "After granting permissions in the helper, click Verify.",
  ...
  "extension_detail.visibility_label": "Visibility",
  "extension_detail.uninstall_action": "Uninstall",
  "extension_detail.type_label": "Type",
  "extension_detail.trigger_label": "Trigger",
  "extension_detail.taxonomy_skill": "A reusable workflow that your agent can execute on demand.",
  "extension_detail.taxonomy_plugin": "Extends OpenWork with additional capabilities managed by your organization.",
  "extension_detail.taxonomy_mcp": "Connects as a Model Context Protocol server, giving your agent access to external tools and data.",
  "extension_detail.taxonomy_connection": "An account your agent can act in, once it is signed in.",
  "extension_detail.taxonomy_app": "Runs on this device and gives your agent tools it can use here.",
  "extension_detail.status_label": "Status",
  "extension_detail.skill_content": "Skill content",
  "extension_detail.shown_value": "Shown",
  "extension_detail.show_action": "Show",
  "extension_detail.setup_label": "Setup",
  "extension_detail.reveal_in_finder": "Reveal in Finder",
  "extension_detail.resources_label": "Resources",
  "extension_detail.release_stage_label": "Release stage",
  "extension_detail.reconnect_label": "Reconnect",
  "extension_detail.provided_by": "Provided by {name}.",
  "extension_detail.prod_discovery_file": "Production discovery file",
  "extension_detail.preview_value": "Preview",
  "extension_detail.override_label": "Override",
  "extension_detail.org_signin_boilerplate": "Available from your organization. Connect your own account to use it.",
  "extension_detail.oauth_required_value": "OAuth required",
  "extension_detail.not_installed_value": "Not installed",
  "extension_detail.not_connected_value": "Not connected",
  "extension_detail.mcp_client_note_before": "Your MCP client starts ",
  "extension_detail.mcp_client_note_after": " over stdio; the wrapper discovers the bridge and proxies UI tools to it.",
  "extension_detail.location_label": "Location",
  "extension_detail.library_state_aria": "Library state",
  "extension_detail.launch_label": "Launch",
  "extension_detail.installed_value": "Installed",
  "extension_detail.installed_skill": "Installed skill",
  "extension_detail.how_to_connect": "How to connect another client",
  "extension_detail.hide_action": "Hide",
  "extension_detail.hidden_value": "Hidden",
  "extension_detail.extension_manifest": "Extension manifest",
  "extension_detail.endpoint_label": "Endpoint",
  "extension_detail.do_not_point_bridge": "Do not point clients at the random localhost bridge URL directly.",
  "extension_detail.discovery_label": "Discovery",
  "extension_detail.disconnected_label": "Setup required",
  "extension_detail.disconnect_action": "Disconnect",
  "extension_detail.dev_discovery_file": "Dev discovery file",
  "extension_detail.details_label": "Details",
  "extension_detail.desktop_bridge_note": "OpenWork desktop starts a private localhost bridge automatically.",
  "extension_detail.current_override": "Current override",
  "extension_detail.contributions_label": "Contributions",
  "extension_detail.connecting_label": "Connecting...",
  "extension_detail.connected_value": "Connected",
  "extension_detail.connected_label": "Available through OpenWork Connect",
  "extension_detail.connect_label": "Connect",
  "extension_detail.beta_value": "Beta",
  "extension_detail.availability_label": "Availability",
  "extension_detail.authentication_label": "Authentication",
  "desktop.use_manager_launcher": "Use manager launcher",
  "desktop.status_repair_external_other": "Another app manages this AppImage. Select its launcher for OpenWork browser callbacks.",
  "desktop.status_repair_external_entry": "The manager-owned launcher cannot accept browser callbacks. Re-integrate this AppImage with its manager.",
  "desktop.status_repair": "The AppImage moved or its launcher, icon, or browser callback needs repair.",
  "desktop.status_managed_external": "This AppImage is integrated by another app. OpenWork will leave its launcher untouched.",
  "desktop.status_integrated": "OpenWork is in your application launcher and handles openwork:// browser callbacks.",
  "desktop.status_add": "Add this AppImage to your application launcher and enable browser sign-in callbacks.",
  "desktop.repair": "Repair",
  "desktop.remove": "Remove",
  "desktop.recheck": "Recheck",
  "desktop.not_integrated": "Not integrated",
  "desktop.needs_repair": "Needs repair",
  "desktop.managed_by_other": "Managed by another app",
  "desktop.integrated": "Integrated",
  "desktop.integrate": "Integrate",
  "desktop.failed": "Desktop integration failed.",
  "desktop.appimage_title": "AppImage desktop integration",
  "desktop.appimage_desc": "Control the launcher, icon, and openwork:// callback for this AppImage.",
  ...
  "extensions.org_extension_files_other": "Organization extension with {count} installed files.",
  "extensions.org_extension_files_one": "Organization extension with {count} installed file.",
  ...
  "imagegen.overrides_env": "Overrides the OPENAI_API_KEY environment variable if set.",
  "imagegen.generate_test_image": "Generate test image",
  "imagegen.env_key_found_desc": "An existing OPENAI_API_KEY was detected. The key you save here will take precedence.",
  "imagegen.env_key_found": "API key found in environment",
  "imagegen.enable": "Enable",
  "imagegen.desc": "Connect OpenAI image generation with an OpenAI API key.",
  "imagegen.config_title": "Configuration",
  "imagegen.api_key_label": "OpenAI API key",
  ...
  "ollama.starting_pull": "Starting pull...",
  "ollama.select_from_loaded": "Select from models already loaded in Ollama.",
  "ollama.running_models_other": "Ollama running ({count} models)",
  "ollama.running_models_one": "Ollama running ({count} model)",
  ...
  "ollama.pull_failed": "Pull failed: {message}",
  "ollama.pull_btn": "Pull {model}",
  "ollama.pull_a_model": "Pull a model",
  "ollama.not_reachable": "Ollama not reachable",
  "ollama.not_installed_desc": "Download and start Ollama to use open-source models in your workspace.",
  "ollama.not_installed": "Ollama isn't installed or running",
  "ollama.no_models_loaded_desc": "Pull a model from ollama.com/library to get started.",
  "ollama.no_models_loaded": "No models loaded",
  "ollama.model_word": "model",
  "ollama.model_to_pull": "Model to pull",
  "ollama.model_name_required": "Model name is required.",
  "ollama.failed_to_pull": "Failed to pull {model}.",
  "ollama.error_prefix": "Error: {message}",
  "ollama.enter_model_name": "Enter a model name from ollama.com/library",
  "ollama.download_ollama": "Download Ollama",
  "ollama.desc": "Connect to a local Ollama instance and choose a model.",
  "ollama.config_title": "Configuration",
  ...
  "onboarding.provider_selection_title": "Power your first task",
  "onboarding.provider_selection_desc": "Connect a model, then try a real task in chat so you can see OpenWork work.",
  "onboarding.provider_openwork_models": "Use OpenWork Models",
  "onboarding.provider_openwork_models_desc": "Pay through OpenWork Cloud and skip API key setup.",
  "onboarding.provider_bring_your_own": "Bring your own API key",
  "onboarding.provider_bring_your_own_desc": "Connect OpenAI, Anthropic, Google, or another provider, then run your first task.",
  "onboarding.provider_skip": "Skip and use the free model",
  "onboarding.attribution_title": "How did you hear about OpenWork?",
  "onboarding.attribution_desc": "One quick question — it helps us know where to show up.",
  "onboarding.attribution_ai_question": "What did you ask the AI?",
  "onboarding.attribution_ai_placeholder": "e.g. \"best open source alternative to Claude Cowork\"",
  "onboarding.attribution_skip_part": "Skip this part",
  "onboarding.attribution_continue": "Continue",
  "onboarding.attribution_option_ai": "An AI assistant",
  "onboarding.attribution_option_ai_desc": "ChatGPT, Claude, Gemini, Perplexity...",
  "onboarding.attribution_option_search": "Search",
  "onboarding.attribution_option_search_desc": "Google, Bing, DuckDuckGo...",
  "onboarding.attribution_option_social": "Social media",
  "onboarding.attribution_option_social_desc": "X, LinkedIn, YouTube, Reddit...",
  "onboarding.attribution_option_github": "GitHub or open source community",
  "onboarding.attribution_option_github_desc": "Repos, stars, awesome lists...",
  "onboarding.attribution_option_friend": "A friend or colleague",
  "onboarding.attribution_option_friend_desc": "Someone recommended it directly.",
  ...
  "voice.save_key": "Save key",
  "voice.realtime_title": "Realtime voice",
  "voice.key_detected_desc": "Voice Mode will use OPENAI_REALTIME_API_KEY when present, otherwise OPENAI_API_KEY from OpenWork environment variables.",
  "voice.key_detected": "OpenAI key detected",
  "voice.desc": "Voice Mode uses OpenAI Realtime and the same OpenWork UI control surface exposed through OpenWork UI MCP.",
  "voice.api_key_label": "OpenAI API key",
  "voice.api_key_field_desc": "Saved as OPENAI_API_KEY in OpenWork's local env store. The renderer only receives short-lived Realtime client secrets.",
