...
export default {
  ...
  "suggestions.connect_provider_hint": "Connect a model provider to get started:",
  "suggestions.try_org_prompts": "Try one of your organization's prompts:",
  "suggestions.try_one": "Try one of these:",
  "suggestions.connect_provider_title": "Connect a model provider",
  "suggestions.connect_provider_desc": "Add an API key for Anthropic, OpenAI, Google, or others",
  ...
  "suggestions.browse_web_desc": "Search Craigslist for couches",
  "suggestions.connect_extension": "Connect an extension",
  "suggestions.connect_extension_desc": "Add MCPs and integrations",
  "model_select.change_model": "Change model",
  "model_select.select_model": "Select model",
  "model_select.search_placeholder": "Search models...",
  "model_select.no_models": "No models found.",
  "model_select.all_models": "All models",
  "model_select.subscribe_hint": "Subscribe to add this model",
  "model_select.signin_hint": "Sign in to unlock",
  "model_select.subscribe": "Subscribe",
  "model_select.signin": "Sign in",
  "model_modal.search_placeholder": "Search providers and models...",
  "model_modal.no_match": "No models match your search.",
  "model_modal.no_available": "No models available. Connect a provider to get started.",
  "model_modal.done": "Done",
  "model_modal.all_models": "All models",
  "provider_auth.title": "Connect providers",
  "provider_auth.description": "Sign in to services or use providers managed by your organization.",
  ...
  "provider_auth.no_available": "No providers available.",
  "provider_auth.arrow_hint": "Arrow keys to navigate, Enter to select.",
  "provider_auth.choose_connect": "Choose how you'd like to connect.",
  "provider_auth.paste_api_key": "Paste your API key to connect.",
  "provider_auth.save_key": "Save key",
  "provider_auth.saving_key": "Saving…",
  "provider_auth.keys_stored_locally": "Keys are stored locally by OpenCode.",
  "provider_auth.connect_org_provider": "Connect with the provider managed by your organization.",
  "provider_auth.connect_provider_btn": "Connect provider",
  "provider_auth.connecting": "Connecting...",
  "provider_auth.loading": "Loading providers…",
  "provider_auth.close": "Close",
  "general.section_workspace": "Workspace",
  "general.section_global": "Global",
  "general.section_help": "Help",
  "general.card_preferences": "Preferences",
  "general.card_preferences_desc": "Default model, reasoning, and compaction.",
  "general.card_permissions": "Permissions",
  "general.card_permissions_desc": "Authorized folders and file access.",
  "general.card_advanced": "Advanced",
  "general.card_advanced_desc": "Runtime, engine, and developer options.",
  "general.card_ai_providers": "AI Providers",
  "general.card_ai_providers_desc": "Connect services that provide AI models.",
  "general.card_cloud": "Cloud",
  "general.card_cloud_desc": "OpenWork Cloud account and organization.",
  "general.card_appearance": "Appearance",
  "general.card_appearance_desc": "Theme, font size, and display.",
  "general.card_environment": "Environment",
  "general.card_environment_desc": "Environment variables and paths.",
  "general.card_updates": "Updates",
  "general.card_updates_desc": "App version and update channel.",
  "general.card_recovery": "Recovery",
  "general.card_recovery_desc": "Reset onboarding and clear data.",
  "session_page.add_model_provider": "Add an AI model provider so your tasks can run.",
  "session_page.try_get_started": "Try one of these to get started:",
  "session_page.edit_csv_desc": "Create a sample spreadsheet with customer data",
  "session_page.browse_web_desc": "Search Craigslist for couches and list the results",
  "session_page.connect_extension_desc": "Add MCP servers, plugins, and integrations",
  "session_page.remote_unavailable": "Remote workspace unavailable",
  "session_page.opencode_unavailable": "OpenCode unavailable",
  "session_page.retry": "Retry",
  "session_page.find_conversation": "Find in conversation",
  "session_page.browser": "Browser",
  "session_page.voice_mode": "Voice Mode",
  "session_page.extensions": "Extensions",
  "session_page.artifacts": "Artifacts ({count})",
  "session_page.no_artifacts": "No artifacts yet",
  "session_page.not_found_title": "Workspace or session not found",
  "side_panel.empty_hint": "Open an artifact or browser tab to get started.",
  "session_surface.change_model": "Change model",
  ...
  "session_search.searching_hint": "Searching messages…",
  "session_search.no_match": "No sessions or messages match your search.",
  "session_search.navigate_hint": "↑↓ to navigate · ↵ to open",
  "find_bar.placeholder": "Find in conversation",
  "find_bar.no_matches": "No matches",
  "find_bar.previous": "Previous match",
  "find_bar.next": "Next match",
  "find_bar.close": "Close find",
  "model_modal.title": "Models",
  "model_modal.subtitle_default": "Select a model for this session.",
  "model_modal.connect_provider": "Connect a provider",
  "model_modal.recommended": "Recommended",
  "model_modal.new_badge": "New",
  "model_modal.current_badge": "Current",
  "model_modal.enabled_badge": "Enabled",
  "model_modal.enable": "Enable",
  "model_modal.models_count": "{count} model",
  "model_modal.models_count_other": "{count} models",
  ...
  "workspace_create.no_folder": "No folder selected yet.",
  "workspace_create.analytics_title": "Want more analytics?",
  "workspace_create.analytics_desc": "Add a project name to group this workspace's sessions in Analytics.",
  "workspace_create.select_folder": "Select folder",
  "remote_fields.worker_url": "Worker URL",
  "remote_fields.worker_url_hint": "Paste the OpenWork worker URL you want to connect to.",
  "remote_fields.access_token": "Access token",
  "remote_fields.access_token_hint": "Add a token only if the worker requires one.",
  "remote_fields.display_name": "Display name",
  "remote_fields.optional": "(optional)",
  "remote_fields.optional_placeholder": "Optional",
  "remote_fields.remote_directory": "Remote directory",
  "remote_fields.remote_directory_hint": "Optionally target a directory within that remote worker.",
  ...
  "updates.alpha": "Alpha",
  "mcp_view.search_placeholder": "Search extensions...",
  "mcp_view.filter_all": "All",
  "mcp_view.filter_mcp": "MCPs",
  "mcp_view.filter_skill": "Skills",
  "mcp_view.show_hidden": "Show hidden ({count})",
  "mcp_view.no_mcp_configured": "No MCP servers configured yet.",
  "mcp_view.from_github": "From GitHub",
  "mcp_view.view_details": "View details",
  "mcp_view.builtins_disabled": "Built-in OpenWork extensions are disabled by your organization. Use Show hidden to review blocked built-ins.",
  "ai_view.title": "AI Providers",
  "ai_view.description": "Connect services that provide AI models",
  "ai_view.providers_connected": "{count} providers connected",
  "ai_view.not_connected": "Not connected",
  "ai_view.hosted_models": "Hosted frontier models without managing API keys.",
  "ai_view.managed_cloud": "Managed by OpenWork Cloud",
  "ai_view.no_api_key": "No API key setup",
  "ai_view.subscribe": "Subscribe",
  "ai_view.connect": "Connect",
  ...
  "marketplace.signin_hint": "You can use OpenWork without an account. Sign in to OpenWork Cloud to load the Marketplace, including OpenWork's built-in extensions and any organization marketplaces.",
  "marketplace.signin_view": "Sign in to view marketplace extensions.",
  "marketplace.loading": "Loading marketplace extensions...",
  "shell.branding_title": "Branding",
  "shell.branding_desc": "Customize the name your users see across the app.",
  "shell.change_app_name": "Change application name",
  "shell.change_app_name_desc": "Appears in the title bar, sidebar, and welcome screen.",
  "shell.layout_title": "Layout",
  "shell.layout_desc": "Customize what's visible in the interface.",
  "shell.cmd_palette_hint": "Anything you hide is still available via the command palette (Cmd+K).",
  "shell.display_sidebar": "Display sidebar",
  "shell.display_sidebar_desc": "Browse workspaces and past sessions from a side panel.",
  "shell.display_status_bar": "Display status bar",
  "shell.display_status_bar_desc": "Quick access to status, settings, and actions along the bottom edge.",
  "shell.status_bar_warning": "When hidden, the only way to access settings is via Cmd+K.",
  "shell.display_docs": "Display documentation link",
  "shell.display_docs_desc": "Show a link to your documentation.",
  "shell.display_feedback": "Display feedback button",
  "shell.display_feedback_desc": "Show a button for submitting feedback.",
  "shell.display_cloud_signin": "Display cloud sign-in",
  "shell.display_cloud_signin_desc": "Show a sign-in prompt for users who aren't logged in.",
  "shell.display_notifications": "Display notifications",
  "shell.display_notifications_desc": "A bell in the header collecting updates from OpenWork Cloud and your workspaces.",
  "shell.display_suggestions": "Display task suggestions",
  "shell.display_suggestions_desc": "Show task suggestions to help users get started.",
  "shell.display_model_picker": "Display model picker",
  "shell.display_model_picker_desc": "Let users choose which AI model to use.",
  "shell.display_browser": "Display browser panel",
  "shell.display_browser_desc": "A built-in browser for viewing web content alongside sessions.",
  "shell.display_menu_bar": "Display menu bar",
  "shell.display_menu_bar_desc": "Show the native desktop menu bar.",
  "shell.display_new_workspace": "Display new workspace button",
  "shell.display_new_workspace_desc": "Let users create or join additional workspaces.",
  "shell.org_settings_title": "Organization-wide settings",
  "shell.org_settings_desc": "These settings are managed by your organization via OpenWork Cloud.",
  "shell.org_admin_warning": "These settings can only be changed by your organization admin. Contact your admin to make changes.",
  "shell.reset_defaults": "Reset to defaults",
  "shell.settings_access": "Settings access",
  "shell.settings_access_desc": "Let users open the settings panel.",
  "shell.model_restrictions": "Model restrictions",
  "shell.model_restrictions_desc": "Limit which AI models and providers users can choose from.",
  "shell.extension_restrictions": "Extension restrictions",
  "shell.extension_restrictions_desc": "Limit which extensions, plugins, and skills users can install.",
  "shell.enable_welcome": "Enable welcome page",
  "shell.enable_welcome_desc": "A getting-started screen for first-time users.",
  "shell.no_custom_name": "Your organization has not set a custom application name.",
  "shell.managed_name": "This application name is managed by your organization.",
  "session_search.group_recent": "Recent sessions",
  "session_search.group_titles": "Session titles",
  "session_search.group_messages": "Messages",
  "session_page.back_history": "Back in conversation history",
  "session_page.forward_history": "Forward in conversation history",
  "session_page.close_tab": "Close tab",
  "session_page.open_split": "Open in split view",
  "session_page.close_split": "Close split",
  "workspace_create.project_name_label": "Project name",
  "workspace_create.project_name_optional": "(optional)",
  "composer.extensions_label": "Extensions",
  "composer.no_extensions": "No extensions enabled. Open Extensions to enable them.",
  "composer.enabled_badge": "Enabled",
  "message.copy": "Copy",
  "message.copied": "Copied!",
  "message.copy_aria": "Copy message",
  "message.branch": "Branch in new chat",
  "message.revert": "Revert",
  "message.revert_aria": "Revert to this message",
  "scroll.jump_start": "Jump to start",
  "scroll.jump_latest": "Jump to latest",
  "mcp_view.showing_hidden": "Showing hidden",
  "mcp_view.show_hidden_label": "Show hidden",
  "mcp_view.no_extensions_found": "No extensions found",
  "mcp_view.no_extensions_hint": "Try a different search, filter, or open Marketplace to add one.",
  "marketplace.signin_to_view": "Sign in to view marketplace extensions.",
  "marketplace.no_available": "No marketplace extensions are available yet.",
  "marketplace.choose_org": "Choose an organization to view marketplace extensions.",
  "shell.unavailable_model_picker": "The model picker display control is not available yet.",
  "shell.unavailable_browser": "The browser panel display control is not available yet.",
  "shell.unavailable_workspace_button": "The new workspace button display control is not available yet.",
  "shell.all_defaults": "All settings are at their defaults.",
  "shell.some_customized": "Some settings have been customized.",
  "advanced.agent_diagnostics_title": "Agent access diagnostics",
  "advanced.agent_diagnostics_desc": "Technical details for OpenWork Cloud MCP delivery. Tokens and Authorization headers are redacted before display or copy.",
  "advanced.cloud_mcp_health": "OpenWork Cloud MCP health",
  "advanced.cloud_mcp_health_desc": "Use this when support needs exact runtime state. The main Connect card stays user-facing.",
  "advanced.copy_sanitized": "Copy sanitized diagnostic",
  "advanced.no_cloud_mcp": "No Cloud MCP health has been loaded for this workspace yet.",
  "advanced.config_sources_title": "OpenCode config sources",
  "advanced.config_sources_desc": "Inspect what OpenWork controls at runtime versus what belongs to your workspace config. This works through the OpenWork server and does not require the OpenCode engine to be healthy.",
  "advanced.move_config_title": "Move OpenWork-managed config",
  "advanced.move_config_desc": "Moves older OpenWork-owned runtime keys from `.opencode/openwork.json` and safe OpenWork-managed keys from `opencode.jsonc` into the runtime database.",
  "advanced.migrating": "Migrating...",
  "advanced.migrate": "Migrate",
  "advanced.desired_config": "Desired OpenWork runtime config",
  "advanced.desired_config_desc": "This is the OpenWork-built config object requested for the runtime database and injected safely by the server. Sensitive headers are redacted here.",
  "advanced.show_desired_json": "Show desired JSON",
  "advanced.source_breakdown": "OpenCode source breakdown",
  "advanced.source_breakdown_desc": "OpenCode also reads its own project and global config files. OpenWork injects the runtime config separately; for OpenWork-managed keys, the injected config is the source to inspect.",
  "advanced.project_config": "Project opencode config",
  "advanced.project_config_desc": "Workspace-level OpenCode config owned by the user/project.",
  "advanced.runtime_hint_chat": "Chat and task creation can use the OpenCode engine for this workspace.",
  "advanced.runtime_hint_db": "Runtime DB, workspace config, and migration diagnostics are available.",
  "extension_desc.openwork-browser": "Automate the built-in browser panel that stays visible inside OpenWork.",
