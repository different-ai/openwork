...
export default {
  ...
  "composer.local_voice_empty": "没有识别到语音。",
  "composer.local_voice_failed": "本地语音输入失败。",
  "composer.local_voice_permission_denied": "麦克风访问被拒绝。请在系统设置中为OpenWork开启权限。",
  "composer.local_voice_preparing": "正在准备本地语音输入",
  "composer.local_voice_setup_required": "本地语音输入尚未安装。",
  "composer.local_voice_start": "开始本地语音输入",
  "composer.local_voice_stop": "停止录音",
  "composer.local_voice_transcribing": "正在本地转写",
