...
export default {
  ...
  "dashboard.create_workspace_subtitle": "为这个工作区选择一个文件夹。OpenWork 会在其中读取和创建文件。",
  "dashboard.create_workspace_confirm": "创建工作区",
  "dashboard.create_sandbox_confirm": "创建为沙盒",
  "dashboard.workspace_explainer_title": "工作区如何运作",
  "dashboard.workspace_explainer_folder": "你选择的文件夹会成为这个工作区保存文件、运行结果和上下文的主目录。",
  "dashboard.workspace_explainer_access": "OpenWork 只会访问这个文件夹，以及你之后明确授权的额外文件夹。",
  "dashboard.workspace_explainer_config": "OpenCode 会把工作区专属配置保存在该文件夹内的 `.opencode/` 中，让每个工作区保持独立。",
  ...
  "dashboard.choose_folder_next": "OpenWork 会把这个文件夹当作工作区主目录。",
  "dashboard.change": "更改",
