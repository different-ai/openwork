...
export default {
  ...
  "dashboard.create_workspace_subtitle": "このワーカー用に 1 つのフォルダを選びます。OpenWork はその中でファイルを読み取り、作成できます。",
  "dashboard.create_workspace_confirm": "ワーカーを作成",
  "dashboard.create_sandbox_confirm": "サンドボックスとして作成",
  "dashboard.workspace_explainer_title": "ワーカーの仕組み",
  "dashboard.workspace_explainer_folder": "選んだフォルダが、このワーカーのファイル・実行・保存済みコンテキストのホームになります。",
  "dashboard.workspace_explainer_access": "OpenWork がアクセスできるのは、そのフォルダと後から明示的に許可した追加フォルダだけです。",
  "dashboard.workspace_explainer_config": "OpenCode はワーカー固有の設定をそのフォルダ内の `.opencode/` に保存するため、ワーカーごとに独立した状態を保てます。",
  ...
  "dashboard.choose_folder_next": "OpenWork はこのフォルダをワーカーのホームとして使います。",
  "dashboard.change": "変更",
