...
export default {
  ...
  "app.error_connect_first": "ランタイム変更を適用する前にこのワーカーに接続してください。",
  ...
  "app.error_pick_local_folder": "ローカルサーバーを再起動する前にローカルワーカーフォルダを選択してください。",
  ...
  "dashboard.cloud_signin_hint": "組織で共有されたリモートワーカーにアクセスできます。",
  ...
  "dashboard.create_shared_subtitle_signed_out": "組織で共有されたワーカーにアクセスするにはOpenWork Cloudにサインインしてください。",
  ...
  "inbox_panel.helper_text": "アプリからこのワーカーとファイルを共有できます。",
  ...
  "message_list.tool_updated_file": "{file}を更新しました",
  "message_list.tool_updated_file_fallback": "ファイルを更新しました",
