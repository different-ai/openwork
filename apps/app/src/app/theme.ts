...
const THEME_PREF_KEY = "micx.react.settings.theme-mode";
const LEGACY_THEME_PREF_KEYS = ["micx.themePref"];
...
const syncNativeTheme = (mode: ThemeMode) => {
  ...
  void window.__MICX_ELECTRON__?.invokeDesktop?.("__setNativeTheme", mode);
};
