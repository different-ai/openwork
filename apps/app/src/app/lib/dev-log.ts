...
type DevRoot = typeof globalThis & {
  __micxDevLogSeq?: number;
  __micxDevLogs?: DevLogRecord[];
};
...
export const recordDevLog = (
  ...
  const id = (root.__micxDevLogSeq ?? 0) + 1;
  root.__micxDevLogSeq = id;
