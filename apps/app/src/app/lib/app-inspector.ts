 ...
 *
 * Consumers read via `window.__micx` from a devtools console or from
...
declare global {
  ...
  var __micx: InspectorAPI | undefined;
}
...
function installIfNeeded() {
  ...
  Object.defineProperty(window, "__micx", {
    value: api,
    configurable: true,
    writable: false,
  });
...
export function recordInspectorEvent(name: string, data?: unknown) {
  installIfNeeded();
  window.__micx?.record(name, data);
}
