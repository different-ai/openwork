...
export function blueprintSessions(config: WorkspaceMicxConfig | null | undefined): WorkspaceBlueprintSessionTemplate[] {
...
export function blueprintMaterializedSessions(config: WorkspaceMicxConfig | null | undefined): WorkspaceBlueprintMaterializedSession[] {
...
export function normalizeWorkspaceMicxConfig(
  value: unknown,
  preset?: string | null,
): WorkspaceMicxConfig {
  const candidate =
    value && typeof value === "object"
      ? (value as Partial<WorkspaceMicxConfig>)
      : {};
