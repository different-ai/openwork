...
const SUPPORT_EMAIL = "team@micxlabs.com";
const SUPPORT_MAILTO = `mailto:${SUPPORT_EMAIL}?subject=Micx%20Den%20remote%20worker%20upgrade`;

/**
 * Small inline link rendered inside the remote-worker error card. When clicked,
 * it opens a dialog explaining the Micx Den upgrade situation and how to
 * reach support.
 */
export function MicxDenHelpLink() {
