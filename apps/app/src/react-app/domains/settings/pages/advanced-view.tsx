...
function AdvancedRuntimeSection(props: {
  engineInfo: EngineInfo | null;
...
function AdvancedOpencodeSection(props: { busy: boolean; enabled: boolean; onToggle: () => void }) {
  return (
...
function AdvancedFeatureFlagsSection(props: {
  busy: boolean;
  microsandboxCreateSandboxEnabled: boolean;
...
function AdvancedDeveloperSection(props: {
  busy: boolean;
  developerMode: boolean;
  opencodeDevModeEnabled: boolean;
  deepLinkOpen: boolean;
...
function AdvancedConnectionSection(props: {
  busy: boolean;
  headerStatus: string;
  baseUrl: string;
  openworkServerUrl: string;
