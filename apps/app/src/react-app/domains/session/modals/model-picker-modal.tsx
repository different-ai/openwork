        ...
        <div className="flex-1 min-w-0">
          ...
          <div
            className={[
              ...
              active ? "text-gray-10" : "text-gray-9 group-hover:text-gray-10",
            ].join(" ")}
          >
        ...
        {(props.opt.behaviorOptions ?? []).map((option) => (
          <button
            ...
            className={[
              ...
              props.opt.behaviorValue === option.value
            ...
            onClick={(event) => {
              ...
              props.onBehaviorChange(
                { providerID: props.opt.providerID, modelID: props.opt.modelID },
                option.value,
              );
            }}
          >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div
            className={[
              "mt-0.5 flex items-center gap-3 text-[11px]",
              isKeyboardActive ? "text-gray-10" : "text-gray-9 group-hover:text-gray-10",
            ].join(" ")}
          >
            <span className="truncate">{t("model_picker.connect_provider_hint")}</span>
            <span className="ml-auto opacity-70">
              {t("model_picker.model_count", { count: props.provider.matchCount })}
            </span>
          </div>
        </div>
      </div>
