import type { MicxSessionMessage } from "@/app/lib/micx-server";
...
function toCacheEntry(updatedAt: number, messages: MicxSessionMessage[]): CacheEntry {
