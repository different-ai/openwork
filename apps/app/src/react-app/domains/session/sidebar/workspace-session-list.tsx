      ...
      <div className="min-h-0 min-w-0 flex-1 overflow-x-hidden overflow-y-auto pr-1">
        <div className="space-y-2 pb-3">
          {props.workspaceSessionGroups.map((group) => {
            ...
            const statusLabel = (() => {
              if (connectionState.status === "error") return connectionState.message?.trim() || "";
            ...
            const statusTone = connectionState.status === "error"
              ? "text-red-11"
              : group.status === "error"
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-3.5">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {statusLabel ? (
                          <div className={`mt-0.5 break-words text-[11px] leading-snug ${statusTone}`}>{statusLabel}</div>
                        ) : null}
                      </div>
                    </div>
