...
function cloudHealth(usable: boolean): MicxCloudMcpHealth {
  return {
    ...
    desired: { present: true, name: "micx-cloud", revision: "rev", config: null, token: { present: true, metadata: {} } },
    ...
    tools: {
      ...
      present: usable ? ["micx-cloud_search_capabilities", "micx-cloud_execute_capability", "other_tool"] : ["micx-cloud_search_capabilities"],
