...
import type { MicxSessionSnapshot } from "../src/app/lib/micx-server";
import {
...
function snapshotWithMessages(
  ...
  return {
    ...
    todos: [],
    status: { type: "idle" },
  } as unknown as MicxSessionSnapshot;
}
...
function snapshotWithText(text: string, sessionId = "ses_test"): MicxSessionSnapshot {
