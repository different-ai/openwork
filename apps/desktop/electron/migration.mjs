...
export function createMigrationIpcContribution({ app }) {
  return defineIpcContribution({
    id: "openwork.tauri-migration.v1",
    registrations: [
      ipcHandle("openwork:migration:read", async () => {
      ...
      ipcHandle("openwork:migration:ack", async () => {
        const snapshotPath = migrationSnapshotPath(app);
