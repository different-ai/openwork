...
const EnvSchema = z.object({
  ...
  WORKER_INTERNAL_HOST: z.string().optional(),
  WORKER_EXTERNAL_HOST: z.string().optional(),
...
export const env = {
  ...
  workerInternalHost: optionalString(parsed.WORKER_INTERNAL_HOST),
  workerExternalHost: optionalString(parsed.WORKER_EXTERNAL_HOST),
