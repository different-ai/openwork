...
const EnvSchema = z.object({
  ...
  STRIPE_SSO_PRICE_ID: z.string().optional(),
  STRIPE_PLAN_PORTAL_CONFIGURATION_ID: z.string().optional(),
...
export const env = {
  ...
  stripe: {
    ...
    teamPriceId: optionalString(parsed.STRIPE_TEAM_PRICE_ID),
    enterprisePriceId: optionalString(parsed.STRIPE_ENTERPRISE_PRICE_ID),
    ssoPriceId: optionalString(parsed.STRIPE_SSO_PRICE_ID),
    planPortalConfigurationId: optionalString(parsed.STRIPE_PLAN_PORTAL_CONFIGURATION_ID),
