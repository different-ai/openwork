import { and, desc, eq, inArray, type SQL, sql } from "@micx-ee/den-db/drizzle"
import { MemoryContextOrigin, MemoryContextTable, MemoryTable } from "@micx-ee/den-db/schema"
import { type DenTypeId, normalizeDenTypeId } from "@micx-ee/utils/typeid"
import { z } from "zod"
