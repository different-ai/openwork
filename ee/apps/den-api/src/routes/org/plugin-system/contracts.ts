...
export const pluginArchRoutePaths = {
  ...
  pluginMcpConnectionDiscovery: `${orgBasePath}/plugins/:pluginId/mcp-connections/discover`,
...
export const pluginArchEndpointContracts: Record<string, EndpointContract> = {
  ...
  discoverPluginMcpRequirement: {
    audience: "admin",
    description: "Discover authentication and configuration requirements for one declared remote MCP server without registering a client or persisting credentials.",
    method: "POST",
    path: pluginArchRoutePaths.pluginMcpConnectionDiscovery,
    request: { body: pluginMcpRequirementDiscoveryRequestSchema, params: pluginParamsSchema },
    response: { description: "Plugin MCP requirement discovery completed successfully.", schema: pluginMcpRequirementDiscoveryResponseSchema, status: 200 },
    tag: "Plugins",
  },
  listPluginAccess: {
    audience: "admin",
