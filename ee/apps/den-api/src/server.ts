...
const stopMcpDiagnosticCleanupLoop = startMcpDiagnosticCleanupLoop()
const stopExternalMcpOAuthPendingGrantCleanupLoop = startExternalMcpOAuthPendingGrantCleanupLoop()
...
async function stopBackgroundLoops() {
  const results = await Promise.allSettled([
    ...
    stopMcpDiagnosticCleanupLoop(),
    stopExternalMcpOAuthPendingGrantCleanupLoop(),
  ])
