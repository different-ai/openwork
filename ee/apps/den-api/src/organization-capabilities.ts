 ...
 */
export const ORGANIZATION_CAPABILITY_KEYS = ["installLinks", "mcpConnections", "modelsAnalytics", "gatewayDashboard", "coworkerTeams"] as const
...
export function normalizeOrganizationCapabilities(metadata: MetadataInput): OrganizationCapabilities {
  ...
  return {
    ...
    coworkerTeams: raw.coworkerTeams === true,
  }
}
...
export function readOrganizationCapabilityOverrides(metadata: MetadataInput): Partial<OrganizationCapabilities> {
  ...
  if (typeof raw.coworkerTeams === "boolean") {
    capabilities.coworkerTeams = raw.coworkerTeams
  }
