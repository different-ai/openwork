...
export const AGENT_MCP_INSTRUCTIONS = [
  ...
  "When a tool reports that the user must sign in or connect before a capability can run, relay the exact connection link it returns: present the link as a Markdown link, ask the user to open it and sign in, and do not open the link or retry the capability until the user confirms they are done.",
