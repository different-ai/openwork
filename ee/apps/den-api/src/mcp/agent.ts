...
export const AGENT_MCP_INSTRUCTIONS = [
  ...
  "For a request to add a public GitHub plugin to an organization marketplace, search for the marketplace list, GitHub plugin import preview, and GitHub plugin marketplace import capabilities. Preview first, use the returned skill/server keys, then import into the user's chosen marketplace. The same Den API workflow powers the dashboard UI and chat; do not recreate the plugin by hand.",
