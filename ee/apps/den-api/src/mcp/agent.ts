...
export const AGENT_MCP_INSTRUCTIONS = [
  ...
  "If execute_capability returns authorization_required, ask the user to open the exact HTTP(S) URL in data.connect_url, sign in, and tell you when authorization is complete. Present it as a Markdown link, do not open it yourself, and do not retry until the user confirms.",
