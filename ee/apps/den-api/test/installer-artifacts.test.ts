...
test("builds the installer asset URL for the configured release", () => {
  expect(installerReleaseAssetUrl("micx-enterprise-mac-arm64-9.9.9.dmg", {
    releaseTag: "v9.9.9+build 2",
    releaseRepo: "different-ai/micx",
  })).toBe("https://github.com/different-ai/micx/releases/download/v9.9.9%2Bbuild%202/micx-enterprise-mac-arm64-9.9.9.dmg")
})

test.each([
  ["mac-arm64", "v9.9.9", "micx-mac-arm64-9.9.9.dmg"],
  ["mac-x64", "9.9.9", "micx-mac-x64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "micx-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "micx-linux-x86_64-9.9.9.AppImage"],
  ["linux-arm64", "v9.9.9", "micx-linux-arm64-9.9.9.AppImage"],
...
test.each([
  ["mac-arm64", "v9.9.9", "micx-enterprise-mac-arm64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "micx-enterprise-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "micx-enterprise-linux-x86_64-9.9.9.AppImage"],
...
test.each([
  ["mac-arm64", "v9.9.9", "micx-cloud-mac-arm64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "micx-cloud-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "micx-cloud-linux-x86_64-9.9.9.AppImage"],
...
test("resolves only a mounted installer asset and reports its size", async () => {
  ...
  const fileName = "micx-enterprise-win-x64-9.9.9.exe"
  ...
  await expect(resolveConfiguredInstallerArtifact("micx-cloud-win-x64-9.9.9.exe")).resolves.toBeNull()
...
test("ignores a directory with the expected filename", async () => {
  const artifactsDir = mkdtempSync(path.join(os.tmpdir(), "ow-installer-artifacts-"))
  const fileName = "micx-cloud-win-x64-9.9.9.exe"
