...
- Handles paywall responses (`402 payment_required`), routes users through Polar checkout during org setup or worker launch, restores saved org drafts after purchase, and only enables worker launch after purchase.
