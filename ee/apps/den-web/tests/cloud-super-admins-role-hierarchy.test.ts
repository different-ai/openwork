...
describe("cloud super-admin role hierarchy", () => {
  ...
  test("exposes exact admin sidebar destinations for Manage, Observability, and Team", () => {
    ...
    for (const label of ["Plugin Directory", "Connectors", "Tool Tester", "Models", "AI Gateway", "OpenWork Models", "Bring Your Own Keys (Legacy)", "Advanced", "Analytics", "Members", "Settings"]) {
