...
describe("cloud super-admin role hierarchy", () => {
  ...
  test("exposes exact admin sidebar destinations for Manage, Observability, and Team", () => {
    ...
    for (const label of ["Collections", "Plugin Directory", "Connectors", "Tool Tester", "Sources", "Models", "OpenWork Models", "Bring your Own Keys", "Workflow Runs", "Analytics", "Members", "Settings"]) {
