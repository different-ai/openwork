export const denDropdownFieldBaseClass = [
  ...
  "dark:border-gray-700 dark:bg-[var(--dls-surface)] dark:text-[var(--dls-text-primary)] dark:focus:border-gray-600 dark:focus:ring-gray-100/10",
].join(" ");

export const denDropdownFieldOpenClass = "border-gray-300 ring-2 ring-gray-900/5 dark:border-gray-600 dark:ring-gray-100/10";
...
export const denDropdownMenuBaseClass = [
  ...
  "dark:border-gray-700 dark:bg-[var(--dls-surface)] dark:shadow-[0_20px_44px_-28px_rgba(0,0,0,0.5)]",
].join(" ");
...
export const denDropdownRowIdleClass = "bg-white hover:bg-gray-50 dark:bg-[var(--dls-surface)] dark:hover:bg-gray-800";

export const denDropdownRowActiveClass = "bg-gray-50 dark:bg-gray-800";

export const denDropdownRowSelectedClass = "bg-gray-50/80 dark:bg-gray-800/80";
