          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-2 border-b-2 pb-3 text-[14px] font-medium transition-colors ${
                selected
                  ? "border-[#0f172a] text-[#0f172a] dark:border-[#e2e8f0] dark:text-[#e2e8f0]"
              ...
              {count !== undefined && count > 0 ? (
                <span
                  className={`rounded-full px-2 py-0.5 text-[11px] font-semibold ${
                    selected ? "bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300" : "bg-gray-100 text-gray-400 dark:bg-gray-800 dark:text-gray-500"
                  }`}
                >
                  {count}
                </span>
