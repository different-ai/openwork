      ...
      {!access.canManageScim ? (
        ...
        <>
          ...
          {health.unresolvedFailureCount > 0 ? (
            <div className="mb-6 rounded-[28px] border border-amber-200 bg-amber-50 px-6 py-5 text-[14px] text-amber-900 dark:border-amber-800/30 dark:bg-amber-950/50 dark:text-amber-200">
          ...
          <div className="mb-6 rounded-[30px] border border-gray-200 dark:border-gray-700 bg-white dark:bg-[var(--dls-surface)] p-6 shadow-[0_18px_48px_-34px_rgba(15,23,42,0.22)]">
            ...
            {visibleToken ? (
              <div className="mt-5 rounded-[24px] bg-[#0f172a] p-6 text-white dark:border dark:border-gray-700 dark:bg-gray-900">
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
