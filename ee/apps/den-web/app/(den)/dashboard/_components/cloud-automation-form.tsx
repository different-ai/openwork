...
export function CloudAutomationForm({ automation, workflow, onClose, onSaved }: Props) {
  ...
  return (
    <section className="mt-6 rounded-2xl border border-sky-100 bg-sky-50/40 p-5">
      ...
      {!cloudEnabled ? <p className="mt-4 rounded-xl border border-amber-100 bg-amber-50 px-3 py-2 text-[12px] text-amber-700">OpenWork Cloud requires OpenWork Web access for this workspace. Purchase OpenWork Web or ask a platform administrator for complimentary access.</p> : null}
