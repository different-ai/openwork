...
export function PluginEditorScreen() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-10">
      ...
      {saveError ? (
        <div className="mt-4 rounded-[16px] border border-red-200 bg-red-50 px-4 py-3 text-[14px] text-red-700 dark:border-red-800/60 dark:bg-red-900/30 dark:text-red-400">
          {saveError}
        </div>
      ) : null}
