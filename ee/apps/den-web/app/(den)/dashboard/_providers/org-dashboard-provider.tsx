...
type OrgDashboardContextValue = {
  ...
  updateOrganizationSettings: (input: { name?: string; allowedEmailDomains?: string[] | null; allowedDesktopVersions?: string[] | null; requireSso?: boolean; brandAppName?: string | null; brandLogoUrl?: string | null; brandIconUrl?: string | null; brandAccentColor?: string | null; externalMcpEngine?: "enterprise" | "legacy" | null }) => Promise<void>;
...
export function OrgDashboardProvider({
  ...
  async function updateOrganizationSettings(input: { name?: string; allowedEmailDomains?: string[] | null; allowedDesktopVersions?: string[] | null; requireSso?: boolean; brandAppName?: string | null; brandLogoUrl?: string | null; brandIconUrl?: string | null; brandAccentColor?: string | null; externalMcpEngine?: "enterprise" | "legacy" | null }) {
    const shouldPublishOrgSettingsCompletion = pathnameRef.current === ORG_SETTINGS_PATH;
    const body: { name?: string; allowedEmailDomains?: string[] | null; allowedDesktopVersions?: string[] | null; requireSso?: boolean; brandAppName?: string | null; brandLogoUrl?: string | null; brandIconUrl?: string | null; brandAccentColor?: string | null; externalMcpEngine?: "enterprise" | "legacy" | null } = {};
    ...
    if (input.externalMcpEngine !== undefined) {
      body.externalMcpEngine = input.externalMcpEngine;
    }
