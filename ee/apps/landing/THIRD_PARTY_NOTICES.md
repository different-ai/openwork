...
These are modified derivative works. Changes by Micx: ported the Astro
markup + inline script to a React component with state-driven feedback,
relabeled the prompt text and copied-feedback copy for Micx, moved the
interaction into the hero prompt block, and applied Micx's ink palette. The
