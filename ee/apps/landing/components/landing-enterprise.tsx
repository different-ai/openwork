...
export function LandingEnterprise(props: Props) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-foreground">
      ...
      <div className="enterprise-page relative z-10 flex min-h-screen flex-col items-center pb-3 pt-(--page-pt) md:pb-4">
        ...
        <main className="mx-auto flex w-full max-w-5xl flex-col gap-16 px-6 pb-24 md:gap-20 md:px-8 md:pb-28">
          <section>
            <div className="max-w-4xl">
              ...
              <p className="max-w-3xl text-lg leading-relaxed text-foreground/70 md:text-xl">
            ...
            <figure
              ...
              className="product-screenshot mt-12 overflow-hidden rounded-xl border border-border-soft shadow-[0_24px_60px_-30px_rgba(1,22,39,0.25)] md:mt-16 lg:-mx-16 xl:-mx-32"
            >
          ...
          <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {stackItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item.title}
                      className="flex flex-col overflow-hidden rounded-xl border border-border-soft bg-surface-card"
                    >
                      <div className="flex h-[220px] items-center justify-center bg-background-muted/60 p-4 md:h-[280px]">
                        {item.id === "desktop" ? (
                          <div className="product-screenshot h-full w-full overflow-hidden rounded-lg border border-border-soft">
                            <div className="relative flex h-7 items-center border-b border-border-soft bg-gradient-to-b from-background-strong to-background-muted px-3">
                              ...
                              <div className="absolute left-1/2 -translate-x-1/2 text-[10px] font-medium tracking-wide text-foreground/60">
                                OpenWork
                              </div>
                            </div>
                            <div className="h-[calc(100%-1.75rem)] overflow-hidden">
                              <div className="origin-top-left scale-[0.58]">
                                <div className="w-[172.413793%] bg-surface-card">
                                  <LandingAppDemoPanel
                          ...
                          <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-surface-card text-foreground">
                            <Icon size={18} />
                          </div>
                        )}
                      </div>
                      <div className="border-t border-border-soft p-5">
                        <h4 className="text-[16px] font-medium tracking-tight text-foreground">
                          {item.title}
                        </h4>
            ...
            <div className="grid gap-6 md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
              <div className="rounded-[2rem] border border-border-soft bg-surface-card p-6 md:p-8">
                <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-border-soft bg-primary-soft px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-primary">
                  <ShieldCheck size={12} />
              ...
              <div className="rounded-[2rem] border border-border-soft bg-surface-card p-6">
                ...
                <h3 className="mb-3 text-[1.35rem] font-medium tracking-tight text-foreground">
