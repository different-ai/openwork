...
export const AuthSessionTable = mysqlTable(
  "session",
  {
    ...
    authenticationProviderId: varchar("authentication_provider_id", { length: 255 }),
    authenticationOrganizationId: denTypeIdColumn("organization", "authentication_organization_id"),
    authenticatedAt: timestamp("authenticated_at", { fsp: 3 }),
